...
typedef const struct tag_tTerminateRoutine_INIB {
    /* call port #_TCP_# */
    struct tag_sRoutineBody_VDES const*cTerminateRoutineBody;
...
#define tTerminateRoutine_N_CELL        (2)  /*  number of cells  #_NCEL_# */
...
#define cTerminateRoutineBody_main( ) \
          tTerminateRoutine_cTerminateRoutineBody_main( p_cellcb )
