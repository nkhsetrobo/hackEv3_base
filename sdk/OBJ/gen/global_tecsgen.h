...
/**/
 ...
 extern void tPutLogMacOSX_CB_initialize();
 extern void tSIOPortMacOSXMain_CB_initialize();
...
#define DefaultTaskStackSize ((const size_t)131072)
#define LogTaskStackSize ((const size_t)131072)
#define BannerTargetName ((const char*)"RasPi")
