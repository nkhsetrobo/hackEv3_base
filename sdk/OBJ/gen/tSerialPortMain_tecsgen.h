...
#define tSerialPortMain_cSIOPort_open( p_that ) \
	  tSIOPortMacOSXMain_eSIOPort_open( \
	   &tSIOPortMacOSXMain_CB_tab[0] )
#define tSerialPortMain_cSIOPort_close( p_that ) \
	  tSIOPortMacOSXMain_eSIOPort_close( \
	   &tSIOPortMacOSXMain_CB_tab[0] )
#define tSerialPortMain_cSIOPort_putChar( p_that, c ) \
	  tSIOPortMacOSXMain_eSIOPort_putChar( \
	   &tSIOPortMacOSXMain_CB_tab[0], (c) )
#define tSerialPortMain_cSIOPort_getChar( p_that ) \
	  tSIOPortMacOSXMain_eSIOPort_getChar( \
	   &tSIOPortMacOSXMain_CB_tab[0] )
#define tSerialPortMain_cSIOPort_enableCBR( p_that, cbrtn ) \
	  tSIOPortMacOSXMain_eSIOPort_enableCBR( \
	   &tSIOPortMacOSXMain_CB_tab[0], (cbrtn) )
#define tSerialPortMain_cSIOPort_disableCBR( p_that, cbrtn ) \
	  tSIOPortMacOSXMain_eSIOPort_disableCBR( \
	   &tSIOPortMacOSXMain_CB_tab[0], (cbrtn) )
