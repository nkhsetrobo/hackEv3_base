...
{
    // pat 1
    {L2RL,GO,L2RL,TL2,L2YL,
    CMDEND},
    //pat 2
    {L2BL,TR1,L2BL,GO,L2RL,
    CMDEND},
    //pat 3
    {L2RL,TL1,L2YR,
    CMDEND},
    //pat 4
    {L2RL,GO,L2RL,TL1,L2YR,
    CMDEND},
    //pat 5
    {   
        L2GL,TR1,L2GL,
...
wParam BlockSectionManager::turn_right1[] = {
   {0, Section::VIRTUAL, Section::TURNANGLE, normal_spd*1.0, 0,rvkp, rvki, rvkd, -20*sign, 0 /*setparam*/, 0, +10.0*sign, 0, 0, _EDGE_R, Judge::UPDATEALL, +88*sign, 0, 0, 0, 0, 0, 0 , 0,Section::JNONE},
...
wParam BlockSectionManager::turn_left1[] = {
   {0, Section::VIRTUAL, Section::TURNANGLE, normal_spd*1.0, 0,rvkp, rvki, rvkd, +24*sign, 0 /*setparam*/, 0, -10.0*sign, 0, 0, _EDGE_R, Judge::UPDATEALL, -88*sign, 0, 0, 0, 0, 0, 0 , 0,Section::JNONE},
...
wParam BlockSectionManager::go_straight[] = {
    {0, Section::VIRTUAL2, Section::LENGTH, normal_spd, 0,lvkp, lvki, lvkd, 0, 0 /*setparam*/, 0, 2, 0, 0, _EDGE_R, Judge::UPDATEALL, 0, 11, 0, 0,0, 0.0, 0 , 0,Section::JNONE},
...
wParam BlockSectionManager::push_red_right[] = {
    ...
    {0, Section::VIRTUAL2, Section::LENGTH, -normal_spd, 0,lvkp, lvki, lvkd, 0, 0 /*setparam*/, -185*sign, 0, 0, 0, _EDGE_R, Judge::UNUPDATE, 0, -10, 0, 0,0,0, 0 , 0,Section::JNONE},
...
wParam BlockSectionManager::rot_red_left[] = {
    ...
    {0, Section::TRACER, Section::LENGTH, normal_spd*0.8, 0,kp, ki, kd, 0, 0 /*setparam*/, 0, 0, 0, 0, !_EDGE_R, Judge::UPDATEALL,0,6, 0, 0, 0, 0, 0 , 0,Section::JNONE},
    {0, Section::VIRTUAL2, Section::COLOR, normal_spd*0.8, 0,lvkp, lvki, lvkd, 0, 0 /*setparam*/, 0, 2, 0, 0, _EDGE_R, Judge::UPDATEALL, 0, 0, 0, 0,RED_H, 0.30, 0 , 0,Section::JNONE},
...
wParam BlockSectionManager::push_yellow_right[] = {
    ...
    {0, Section::VIRTUAL2, Section::LENGTH, -normal_spd, 0,lvkp, lvki, lvkd, 0, 0 /*setparam*/, -185*sign, 0, 0, 0, _EDGE_R, Judge::UNUPDATE, 0, -10, 0, 0,0,0, 0 , 0,Section::JNONE},
    {0, Section::TRACER, Section::LENGTH, normal_spd*0.8, 0,kp, ki, kd, 0, 0 /*setparam*/, 0, 0, 0, 0, _EDGE_R, Judge::UPDATEALL,0,6, 0, 0, 0, 0, 0 , 0,Section::JNONE},
    {0, Section::VIRTUAL2, Section::COLOR, normal_spd*0.8, 0,lvkp, lvki, lvkd, 0, 0 /*setparam*/, 0, 2, 0, 0, _EDGE_R, Judge::UPDATEALL, 0, 0, 0, 0,YELLOW_H, 0.4, 0 , 0,Section::JNONE},
    {0, Section::VIRTUAL2, Section::LENGTH, normal_spd*0.8, 0,lvkp, lvki, lvkd, 0, 0 /*setparam*/, 0, 2, 0, 0, _EDGE_R, Judge::UPDATEALL, 0, 1, 0, 0,0,0, 0 , 0,Section::JNONE}, //黄色は検知が早いい
...
wParam BlockSectionManager::rot_blue_left[] = {
    ...
    {0, Section::TRACER, Section::LENGTH, normal_spd*0.8, 0,kp, ki, kd, 0, 0 /*setparam*/, 0, 0, 0, 0, !_EDGE_R, Judge::UPDATEALL,0,6, 0, 0, 0, 0, 0 , 0,Section::JNONE},
    {0, Section::VIRTUAL2, Section::COLOR, normal_spd*0.8, 0,lvkp, lvki, lvkd, 0, 0 /*setparam*/, 0, 2, 0, 0, _EDGE_R, Judge::UPDATEALL, 0, 0, 0, 0,BLUE_H, 0.20, 0 , 0,Section::JNONE},
