...
wParam abbb[100] = 
                  ...
                  //第二コーナー
                  {0, Section::VIRTUAL, Section::TURNANGLE, 38, 0, 30, 0.1, 0.2, 1, 1 /*setparam*/, 0, 59, 0, 0, true, Judge::UPDATE, 80.3, 0, 0, 0, 0, 0, 0},
                  //第二直線
                  {0, Section::VIRTUAL2, Section::LENGTH, 43, 0, 24, 3, 20, 1, 1 /*setparam*/, 80.3, 0, 0, 0, true, Judge::UPDATE, 0, 95, 0, 0, 0, 0, 0},
                  //第三カーブ
                  ...
                  //ラストカーブ①
                  {0, Section::VIRTUAL, Section::TURNANGLE, 38, 0, 30, 5, 0.3, 1, 1 /*setparam*/, 0, -25, 0, 0, true, Judge::UPDATE, -42.3, 0, 0, 0, 0, 0, 0},
                  //{0, Section::WALKER, Section::LENGTH, 0, 0, 0, 0, 0, 1, 1 /*setparam*/, 0, 0, 50, 0, true, Judge::UPDATE, 0, 46, 0, 0, 0, 0, 0},
                  {0, Section::VIRTUAL2, Section::LENGTH, 43, 0, 24, 3, 20, 1, 1 /*setparam*/, -42, 0, 0, 0, true, Judge::UPDATE, 0, 46, 0, 0, 0, 0, 0},
                  ...
                  //ゴール
                  //ライン復帰
                  {0, Section::VIRTUAL, Section::TURNANGLE, 45, 0, 30, 5, 0.3, 1, 1 /*setparam*/, 0, -32, 0, 0, true, Judge::UPDATE, -43, 0, 0, 0, 0, 0, 0},
                  ...
                  {0, Section::VIRTUAL, Section::TURNANGLE, 20, 0, 30, 5, 0.5, 1, 1 /*setparam*/, 0, -1, 0, 0, true, Judge::UPDATE, -26, 0, 0, 0, 0, 0, 0},
                  {0, Section::TRACER, Section::LENGTH, 7, 0, 30, 5, 0.3, 1, 1 /*setparam*/, 0, 0, 0, 0, false, Judge::UPDATE, 0, 10, 0, 0, 0, 0, 0},
