...
void BlockList::initList()
{
	...
	pass_list[0] =
	{
		{1.0, 0.0},{0.0,0.0},12.0,WEST,
        {
            ...
            {Section::TRACER, 0, 0, {0,0}, 10, 0, 0, 0, Section::LENGTH, 12, {0,0}, BLUE, 0, 30, 0.7, 5, false },
    ...
    pass_list[2] =
    {
        {1.0,0.0},{0.0,2.0},13.0,WEST,
        {
            ...
            {Section::TRACER, 0, 0, {0, 0}, 15, 0, 0, 0, Section::LENGTH, 10, {0, 0}, BLUE, 0, 30, 0.7, 5, true},
    ...
    pass_list[5] =
    {
        {1.0,0.0},{0.5,1.5},9.0,SOUTH,
        {
            ...
            {Section::WALKER, -15, 0, {0,0}, 0, 0, 0, 0, Section::LENGTH, -3, {0,0}, BLUE, 0, 30, 0.7, 5, true},
            {Section::VIRTUAL, 0, 0, {0,0}, -25, 0, 0, -10, Section::TURNANGLE, 51, {0,0}, BLUE, 0, 30, 0.7, 5, false},
            {Section::WALKER, -15, 0, {0,0}, 0, 0, 0, 0, Section::LENGTH, -22, {0,0}, BLUE, 0, 30, 0.7, 5, true},
            {Section::VIRTUAL2, 0, 0, {0,0}, 0, 0, 0, 0, Section::STOP, 50, {0,0}, BLUE, 0, 0, 0, 0, true},
    ...
    pass_list[6] =
    {
        {1.0,0.0},{0.5,2.5},12.0,SOUTH,
        {
            ...
            {Section::VIRTUAL, 0, 0, {0, 0}, 5, 0, 0, -6.5, Section::TURNANGLE, -92, {0, 0}, BLUE, 0, 0.5, 0.7, 2, false},
            {Section::TRACER, 0, 0, {0, 0}, 10, 0, 0, 0, Section::LENGTH, 10, {0, 0}, BLUE, 0, 30, 0.7, 5, true},
            {Section::WALKER, 20, 0, {0, 0}, 0, 0, 0, 0, Section::COLOR, 0, {1, 0}, BLUE, 0, 30, 0.7, 5, true},
            //li2	サークル突破(左)
            {Section::WALKER,25,0,{0,0},0,0,0,0,Section::LENGTH,10,{0,0},BLUE,0,0,0,0,true},
            {Section::TRACER,0,0,{0,0},20,0,0,0,Section::LENGTH,15,{0,0},BLUE,0,30,0.7,5,true},
            {Section::WALKER, 20, 0, {0, 0}, 0, 0, 0, 0, Section::COLOR,0,{1,1},BLUE,0,30,0.7,5,true},
    ...
    pass_list[11] =
    {
        {1.0,0.0},{1.5,0.5},4.0,EAST,
        {
            ...
            {Section::WALKER, -15, 0, {0,0}, 0, 0, 0, 0, Section::LENGTH, -20, {0,0}, BLUE, 0, 30, 0.7, 5, true},
            {Section::VIRTUAL2, 0, 0, {0,0}, 0, 0, 0, 0, Section::STOP, 50, {0,0}, BLUE, 0, 0, 0, 0, true},
            {Section::TRACER, 0, 0, {0,0}, 15, 0, 0, 0, Section::LENGTH, 10, {0,0}, BLUE, 0, 30, 0.7, 5, false},
            {Section::WALKER, 20, 0, {0, 0}, 0, 0, 0, 0, Section::COLOR, 0, {1,0}, BLUE, 0, 30, 0.7, 5, false},
            //終了
    ...
    pass_list[12] =
    {
        {1.0,0.0},{1.5,2.5},12.5,SOUTH,
        {
            ...
            {Section::VIRTUAL2, 0, 0, {0,0}, 0, 0, 0, 0, Section::STOP, 50, {0,0}, BLUE, 0, 0, 0, 0, true},
            {Section::WALKER, -15, 0, {0,0}, 0, 0, 0, 0, Section::LENGTH, -4, {0,0}, BLUE, 0, 30, 0.7, 5, true},
            {Section::VIRTUAL, 0, 0, {0,0}, -25, 0, 0, 17.5, Section::TURNANGLE, -54.5, {0,0}, BLUE, 0, 30, 0.7, 5, false},
            {Section::WALKER, -15, 0, {0,0}, 0, 0, 0, 0, Section::LENGTH, -15, {0,0}, BLUE, 0, 30, 0.7, 5, true},
            {Section::VIRTUAL2, 0, 0, {0,0}, 0, 0, 0, 0, Section::STOP, 50, {0,0}, BLUE, 0, 0, 0, 0, true},
            {Section::TRACER, 0, 0, {0,0}, 15, 0, 0, 0, Section::LENGTH, 10, {0,0}, BLUE, 0, 30, 0.7, 5, false},
            {Section::WALKER, 20, 0, {0, 0}, 0, 0, 0, 0, Section::COLOR, 0, {1,2}, BLUE, 0, 30, 0.7, 5, false},
            //終了
    ...
    pass_list[13] =
    {
        {1.0,0.0},{2.0,0.0},3.0,EAST,
        {
            ...
            //le1	右ななめ(右から右)
            {Section::WALKER, 25, 0, {0,0}, 0, 0, 0, 0, Section::LENGTH, 3, {0,0}, BLUE, 0, 30, 0.7, 5, true}, 
            {Section::VIRTUAL, 0, 0, {0,0}, 15, 0, 0, -18, Section::LENGTH, 13.5, {0,0}, BLUE, 0, 30, 0.7, 5, true},
            {Section::VIRTUAL2, 0, 0, {0,0}, 0, 0, 0, 0, Section::STOP, 50, {0,0}, BLUE, 0, 0, 0, 0, true},
            {Section::WALKER, -15, 0, {0,0}, 0, 0, 0, 0, Section::LENGTH, -3, {0,0}, BLUE, 0, 30, 0.7, 5, true},
            {Section::VIRTUAL, 0, 0, {0,0}, -25, 0, 0, -16.5, Section::TURNANGLE, 47.5, {0,0}, BLUE, 0, 30, 0.7, 5, false},
            {Section::WALKER, -15, 0, {0,0}, 0, 0, 0, 0, Section::LENGTH, -20, {0,0}, BLUE, 0, 30, 0.7, 5, true},
            {Section::VIRTUAL2, 0, 0, {0,0}, 0, 0, 0, 0, Section::STOP, 50, {0,0}, BLUE, 0, 0, 0, 0, true},
            {Section::TRACER, 0, 0, {0,0}, 15, 0, 0, 0, Section::LENGTH, 10, {0,0}, BLUE, 0, 30, 0.7, 5, false},
    ...
    pass_list[14] =
    {
        {1.0,0.0},{2.0,1.0},2.0,SOUTH,
        {
            ...
            {Section::VIRTUAL, 0, 0, {0, 0}, 10, 0, 0, -26, Section::TURNANGLE, -30, {0, 0}, BLUE, 0, 0.5, 0.7, 3, false},
            {Section::VIRTUAL, 0, 0, {0, 0}, 10, 0, 0, -26, Section::BRIGHTNESS, -0.5, {0, 0}, BLUE, 0, 0.5, 0.7, 3, false},
            {Section::VIRTUAL, 0, 0, {0, 0}, 5, 0, 0, -0.5, Section::TURNANGLE, -16, {0, 0}, BLUE, 0, 0.5, 0.7, 3, false},
            {Section::TRACER, 0, 0, {0, 0}, 10, 0, 0, 0, Section::LENGTH, 15, {0, 0}, BLUE, 0, 30, 0.7, 5, true},
    ...
    pass_list[24] =
    {
        ...
        {
            //lb1	色検知、左カーブ(右から右)
            {Section::WALKER, 3, 0, {0, 0}, 0, 0, 0, 0, Section::LENGTH, 2, {0, 0}, BLUE, 0, 30, 0.7, 5, false},
			{Section::VIRTUAL, 0, 0, {0, 0}, 5, 0, 0, 8, Section::TURNANGLE, 75, {0, 0}, BLUE, 0, 10, 0.7, 3, false},
			{Section::TRACER, 0, 0, {0, 0}, 10, 0, 0, 0, Section::LENGTH, 20, {0, 0}, BLUE, 0, 30, 0.7, 5, false},
            {Section::WALKER, 20, 0, {0, 0}, 0, 0, 0, 0, Section::COLOR, 0, {1, 0}, BLUE, 0, 30, 0.7, 5, false},
            //lb1	色検知、左カーブ(右から右)
            {Section::WALKER, 3, 0, {0, 0}, 0, 0, 0, 0, Section::LENGTH, 2, {0, 0}, BLUE, 0, 30, 0.7, 5, false},
			{Section::VIRTUAL, 0, 0, {0, 0}, 5, 0, 0, 8, Section::TURNANGLE, 75, {0, 0}, BLUE, 0, 10, 0.7, 3, false},
    ...
    pass_list[35] =
    {
        ...
        {
            //lf1	左ななめ(右から右)
			{Section::WALKER, 15, 0, {0,0}, 10, 0, 0, 0, Section::LENGTH, 3, {0,0}, BLUE, 0, 30, 0.7, 5, true},
			{Section::VIRTUAL, 0, 0, {0,0}, 15, 0, 0, 19.5, Section::LENGTH, 16, {0,0}, BLUE, 0, 15, 0.7, 5, true},
			{Section::VIRTUAL2, 0, 0, {0,0}, 0, 0, 0, 0, Section::STOP, 50, {0,0}, BLUE, 0, 0, 0, 0, true},
			{Section::WALKER, -10, 0, {0,0}, 0, 0, 0, 0, Section::LENGTH, -5, {0,0}, BLUE, 0, 30, 0.7, 5, true},
			{Section::VIRTUAL, 0, 0, {0,0}, -10, 0, 0, 15, Section::TURNANGLE, -49, {0,0}, BLUE, 0, 30, 0.7, 5, false},
			{Section::WALKER, -10, 0, {0,0}, 0, 0, 0, 0, Section::LENGTH, -18, {0,0}, BLUE, 0, 30, 0.7, 5, true},
			{Section::VIRTUAL2, 0, 0, {0,0}, 0, 0, 0, 0, Section::STOP, 50, {0,0}, BLUE, 0, 0, 0, 0, true},
            {Section::TRACER, 0, 0, {0, 0}, 7, 0, 0, 0, Section::LENGTH, 10, {0,0}, BLUE, 0, 30, 0.7, 5, false},
            {Section::WALKER, 20, 0, {0, 0}, 0, 0, 0, 0, Section::COLOR, 0, {1,1}, BLUE, 0, 30, 0.7, 5, false},
            //終了
            {Section::VIRTUAL,-1,0,{0,0},0,0,0,0,Section::TURNANGLE,0,{0,0},BLUE,0,0,0,0,true}
    ...
    pass_list[44] =
    {
        {1.0,1.0},{3.0,0.0},11.5,NORTH,
        {
            ...
            {Section::TRACER, 0, 0, {0, 0}, 15, 0, 0, 0, Section::LENGTH, 12, {0, 0}, BLUE, 0, 30, 0.7, 5, false},
            {Section::WALKER, 20, 0, {0, 0}, 0, 0, 0, 0, Section::COLOR, 0, {3, 0}, BLUE, 0, 30, 0.7, 5, false},
            //終わり
            {Section::VIRTUAL, -1, 0, {0, 0}, 0, 0, 0, 0, Section::LENGTH, 0, {0, 0}, BLUE, 0, 0, 0, 0, false}
    ...
    pass_list[97] =
    {
        {2.0,0.0},{0.0,1.0},13.0,WEST,
        {
            ...
            {Section::VIRTUAL, 0, 0, {0, 0}, 5, 0, 0, -6.5, Section::TURNANGLE, -92, {0, 0}, BLUE, 0, 0.5, 0.7, 2, false},
            {Section::TRACER, 0, 0, {0, 0}, 10, 0, 0, 0, Section::LENGTH, 10, {0, 0}, BLUE, 0, 30, 0.7, 5, true},
            {Section::WALKER, 20, 0, {0, 0}, 0, 0, 0, 0, Section::COLOR, 0, {2, 1}, BLUE, 0, 30, 0.7, 5, true},
            //la3	色検知、右カーブ(左から右)
            {Section::VIRTUAL, 0, 0, {0, 0}, 5, 0, 0, -3, Section::TURNANGLE, -100, {0, 0}, BLUE, 0,0.5, 0.7, 3, false},
            {Section::VIRTUAL, 0, 0, {0, 0}, 5, 0, 0, 3, Section::TURNANGLE, 5, {0, 0}, BLUE, 0, 0.5, 0.7, 3, false},
            {Section::TRACER, 0, 0, {0,0}, 10, 0, 0, 0, Section::LENGTH, 12, {0,0}, BLUE, 0, 30, 0.7, 5, false },
...
{Section::VIRTUAL, -1, 0, {0, 0}, 0, 0, 0, 0, Section::LENGTH, 0, {0, 0}, BLUE, 0, 0, 0, 0, false}
    ...
    pass_list[147] =
    {
        {2.0,2.0},{0.0,3.0},13.0,NORTH,
        {
            ...
            {Section::VIRTUAL, 0, 0, {0, 0}, 5, 0, 0, -6.5, Section::TURNANGLE, -92, {0, 0}, BLUE, 0, 0.5, 0.7, 2, false},
            {Section::TRACER, 0, 0, {0, 0}, 10, 0, 0, 0, Section::LENGTH, 10, {0, 0}, BLUE, 0, 30, 0.7, 5, true},
            {Section::WALKER, 20, 0, {0, 0}, 0, 0, 0, 0, Section::COLOR, 0, {0, 0}, BLUE, 0, 30, 0.7, 5, true},
            //終わり
            {Section::VIRTUAL, -1, 0, {0, 0}, 0, 0, 0, 0, Section::LENGTH, 0, {0, 0}, BLUE, 0, 0, 0, 0, false}
    ...
    pass_list[150] =
    {
        {2.0,2.0},{0.5,2.5},14.0,SOUTH,
        {
            ...
            {Section::VIRTUAL, 0, 0, {0, 0}, 5, 0, 0, -6.5, Section::TURNANGLE, -92, {0, 0}, BLUE, 0, 0.5, 0.7, 2, false},
            {Section::TRACER, 0, 0, {0, 0}, 10, 0, 0, 0, Section::LENGTH, 10, {0, 0}, BLUE, 0, 30, 0.7, 5, true},
            {Section::WALKER, 20, 0, {0, 0}, 0, 0, 0, 0, Section::COLOR, 0, {2, 3}, BLUE, 0, 30, 0.7, 5, true},
            //la4	色検知、右カーブ(左から左)
            {Section::VIRTUAL, 0, 0, {0, 0}, 10, 0, 0, -6.5, Section::TURNANGLE, -92, {0, 0}, BLUE, 0, 0.5, 0.7, 2, false},
            {Section::TRACER, 0, 0, {0, 0}, 10, 0, 0, 0, Section::LENGTH, 5, {0, 0}, BLUE, 0, 30, 0.7, 5, true},
            {Section::WALKER, 20, 0, {0, 0}, 0, 0, 0, 0, Section::COLOR, 0, {1, 3}, BLUE, 0, 30, 0.7, 5, true},
    ...
    pass_list[193] =
    {
        {3.0,0.0},{0.0,1.0},16.0,WEST,
        {
            ...
            {Section::VIRTUAL, 0, 0, {0, 0}, 5, 0, 0, -6.5, Section::TURNANGLE, -92, {0, 0}, BLUE, 0, 0.5, 0.7, 2, false},
            {Section::TRACER, 0, 0, {0, 0}, 10, 0, 0, 0, Section::LENGTH, 10, {0, 0}, BLUE, 0, 30, 0.7, 5, true},
            {Section::WALKER, 20, 0, {0, 0}, 0, 0, 0, 0, Section::COLOR, 0, {3, 1}, BLUE, 0, 30, 0.7, 5, true},
            //la3	色検知、右カーブ(左から右)
            {Section::VIRTUAL, 0, 0, {0, 0}, 5, 0, 0, -3, Section::TURNANGLE, -100, {0, 0}, BLUE, 0,0.5, 0.7, 3, false},
            {Section::VIRTUAL, 0, 0, {0, 0}, 5, 0, 0, 3, Section::TURNANGLE, 5, {0, 0}, BLUE, 0, 0.5, 0.7, 3, false},
            {Section::TRACER, 0, 0, {0,0}, 10, 0, 0, 0, Section::LENGTH, 12, {0,0}, BLUE, 0, 30, 0.7, 5, false },
    ...
    pass_list[243] =
    {
        {3.0,2.0},{0.0,3.0},16.0,WEST,
        {
            ...
            {Section::VIRTUAL, 0, 0, {0, 0}, 5, 0, 0, -6.5, Section::TURNANGLE, -92, {0, 0}, BLUE, 0, 0.5, 0.7, 2, false},
            {Section::TRACER, 0, 0, {0, 0}, 10, 0, 0, 0, Section::LENGTH, 10, {0, 0}, BLUE, 0, 30, 0.7, 5, true},
            {Section::WALKER, 20, 0, {0, 0}, 0, 0, 0, 0, Section::COLOR, 0, {3, 3}, BLUE, 0, 30, 0.7, 5, true},
            //la3	色検知、右カーブ(左から右)
            {Section::VIRTUAL, 0, 0, {0, 0}, 5, 0, 0, -3, Section::TURNANGLE, -100, {0, 0}, BLUE, 0,0.5, 0.7, 3, false},
            {Section::VIRTUAL, 0, 0, {0, 0}, 5, 0, 0, 3, Section::TURNANGLE, 5, {0, 0}, BLUE, 0, 0.5, 0.7, 3, false},
            {Section::TRACER, 0, 0, {0,0}, 10, 0, 0, 0, Section::LENGTH, 12, {0,0}, BLUE, 0, 30, 0.7, 5, false },
    ...
    pass_list[275] =
    {
        {3.0,3.0},{1.5,0.5},18.0,NORTH,
        {
            ...
            //lb1	色検知、左カーブ(右から右)
            {Section::WALKER, 3, 0, {0, 0}, 0, 0, 0, 0, Section::LENGTH, 2, {0, 0}, BLUE, 0, 30, 0.7, 5, false},
			{Section::VIRTUAL, 0, 0, {0, 0}, 5, 0, 0, 8, Section::TURNANGLE, 80, {0, 0}, BLUE, 0, 10, 0.7, 3, false},
			{Section::TRACER, 0, 0, {0, 0}, 10, 0, 0, 0, Section::LENGTH, 20, {0, 0}, BLUE, 0, 30, 0.7, 5, false},
            {Section::WALKER, 20, 0, {0, 0}, 0, 0, 0, 0, Section::COLOR, 0, {2, 2}, BLUE, 0, 30, 0.7, 5, false},
            //la2	色検知、右カーブ(右から左)
            {Section::VIRTUAL, 0, 0, {0, 0}, 5, 0, 0, -6.5, Section::TURNANGLE, -92, {0, 0}, BLUE, 0, 0.5, 0.7, 2, false},
