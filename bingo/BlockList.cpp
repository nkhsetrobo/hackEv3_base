...
void BlockList::initList()
{
    ...
    pass_list[18] =
    {
        {1.0,0.0},{2.5,1.5},11.5,SOUTH,
        {
			...
			{Section::VIRTUAL, 0, 0, {0,0}, 10, 0, 0, 19, Section::TURNANGLE, 52, {0,0}, BLUE, 0, 30, 25, 3, true},
			{Section::WALKER, 0, 0, {0,0}, 0, 0, 0, 0, Section::STOP, 50, {0,0}, BLUE, 0, 0, 0, 0, true},
			{Section::WALKER, -10, 0, {0,0}, 0, 0, 0, 0, Section::LENGTH, -6, {0,0}, BLUE, 0, 39, 25, 5, true},
			{Section::VIRTUAL, 0, 0, {0,0}, -10, 0, 0, 11, Section::TURNANGLE, -52, {0,0}, BLUE, 0, 30, 25, 3, false},
			{Section::VIRTUAL2, 0, 0, {0,0}, -10, 0, 0, 128, Section::LENGTH, -9, {0,0}, BLUE, 0, 39, 25, 5, true},
			{Section::WALKER, 0, 0, {0,0}, 0, 0, 0, 0, Section::STOP, 50, {0,0}, BLUE, 0, 0, 0, 0, true},
