...
void BlockList::initList()
{
    ...
    pass_list[18] =
    {
        {1.0,0.0},{2.5,1.5},12.5,SOUTH,
        {
			...
			{Section::VIRTUAL, 0, 0, {0,0}, 15, 0, 0, 19, Section::TURNANGLE, 52, {0,0}, BLUE, 0, 15, 0.7, 5, true},
			{Section::VIRTUAL2, 0, 0, {0,0}, 0, 0, 0, 0, Section::STOP, 50, {0,0}, BLUE, 0, 0, 0, 0, true},
    ...
    pass_list[24] =
    {
        ...
        {
            //lb1	色検知、左カーブ(右から右)
			{Section::VIRTUAL, 0, 0, {0, 0}, 12, 0, 0, 11, Section::TURNANGLE, 80, {0, 0}, BLUE, 0, 24, 25, 5, false},
