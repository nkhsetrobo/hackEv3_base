...
void BlockList::initList()
{
    ...
    pass_list[14] =
    {
        {1.0,0.0},{2.0,1.0},2.0,SOUTH,
        {
            ...
            {Section::TRACER, 0, 0, {0, 0}, 16, 0, 0, 0, Section::LENGTH, 8.5, {0, 0}, BLUE, 0, 20, 10, 3, false},
            {Section::VIRTUAL, 0, 0, {0, 0}, 16, 0, 0, -25, Section::LENGTH, 21, {0, 0}, BLUE, 0, 23, 15, 3, false},
