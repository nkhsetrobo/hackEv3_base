...
void BlockList::initList()
{
    ...
    pass_list[10] =
    {
        {1.0,0.0},{1.0,3.0},11.0,SOUTH,
        {
            ...
            //li1	サークル突破(右)
            {Section::WALKER,25,0,{0,0},0,0,0,0,Section::LENGTH,10,{0,0},BLUE,0,0,0,0,false},
            {Section::VIRTUAL2, 0, 0, {0,0}, 28, 0, 0, 0, Section::LENGTH, 30, {0,0}, BLUE, 0, 39, 25, 5, true},
            {Section::VIRTUAL2, 0, 0, {0,0}, 20, 0, 0, 0, Section::LENGTH, 10, {0,0}, BLUE, 0, 39, 25, 5, true},
    ...
    pass_list[44] =
    {
        {1.0,1.0},{3.0,0.0},11.5,NORTH,
        {
            ...
            {Section::WALKER, 15, 0, {0, 0}, 0, 0, 0, 0, Section::COLOR,0,{2,1},BLUE,0,30,0.7,5,false},
            //ld1	色未検知、左カーブ(右から右)
            {Section::WALKER, 25, 0, {0, 0}, 0, 0, 0, 0, Section::LENGTH, 17, {0, 0}, BLUE, 0, 0, 0, 0, false},
            ...
            {Section::VIRTUAL, 0, 0, {0, 0}, 12, 0, 0, 7, Section::LENGTH, 5, {0, 0}, BLUE, 0, 39, 25, 5, false},
            {Section::TRACER, 0, 0, {0, 0}, 10, 0, 0, 0, Section::LENGTH, 7, {0, 0}, BLUE, 0, 39, 25, 5, false},
