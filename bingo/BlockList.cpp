...
void BlockList::initList()
{
    ...
    pass_list[1] =
    {
        {1.0, 0.0},{0.0,1.0},10.0,WEST,
        {
            ...
            //la3	色検知、右カーブ(左から右)
            {Section::WALKER, 12, 0, {0,0}, 10, 0, 0, 0, Section::LENGTH, 2, {0,0}, BLUE, 0, 39, 25, 5, true},
            {Section::VIRTUAL, 0, 0, {0, 0}, 12, 0, 0, -9, Section::TURNANGLE, -90, {0, 0}, BLUE, 0, 28, 20, 3, false},
            {Section::TRACER, 0, 0, {0, 0}, 12, 0, 0, 0, Section::LENGTH, 7, {0, 0}, BLUE, 0, 25, 20, 10, false},
            {Section::TRACER, 0, 0, {0, 0}, 18, 0, 0, 0, Section::LENGTH, 7, {0, 0}, BLUE, 0, 25, 20, 10, false},
