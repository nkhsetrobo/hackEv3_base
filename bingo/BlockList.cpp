...
void BlockList::initList()
{
    ...
    pass_list[14] =
    {
        {1.0,0.0},{2.0,1.0},2.0,SOUTH,
        {
            ...
            {Section::VIRTUAL, 0, 0, {0, 0}, 15, 0, 0, -29, Section::LENGTH, 22.5, {0, 0}, BLUE, 0, 20, 10, 3, false},
            ...
            {Section::TRACER, 0, 0, {0, 0}, 8, 0, 0, 0, Section::LENGTH, 7, {0, 0}, BLUE, 0, 39, 25, 5, false},
