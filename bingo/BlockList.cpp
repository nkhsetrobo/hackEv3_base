...
void BlockList::initList()
{
    ...
    pass_list[13] =
    {
        {1.0,0.0},{2.0,0.0},3.0,EAST,
        {
            ...
            {Section::VIRTUAL, 0, 0, {0,0}, -16, 0, 0, -16.5, Section::TURNANGLE, 48.7, {0,0}, BLUE, 0, 39, 25, 5, false},
            {Section::WALKER, -15, 0, {0,0}, 0, 0, 0, 0, Section::LENGTH, -18, {0,0}, BLUE, 0, 39, 25, 5, true},
            {Section::VIRTUAL2, 0, 0, {0,0}, 0, 0, 0, 0, Section::STOP, 50, {0,0}, BLUE, 0, 0, 0, 0, true},
    ...
    pass_list[24] =
    {
        ...
        {
            //lb1	色検知、左カーブ(右から右)
			{Section::VIRTUAL, 0, 0, {0, 0}, 8, 0, 0, 10, Section::TURNANGLE, 95, {0, 0}, BLUE, 0, 24, 25, 5, false},
            {Section::TRACER, 0, 0, {0, 0}, 8, 0, 0, 0, Section::LENGTH, 12, {0, 0}, BLUE, 0, 39, 25, 5, false},
			{Section::TRACER, 0, 0, {0, 0}, 15, 0, 0, 0, Section::LENGTH, 8, {0, 0}, BLUE, 0, 39, 25, 5, false},
            {Section::WALKER, 20, 0, {0, 0}, 0, 0, 0, 0, Section::COLOR, 0, {1, 0}, BLUE, 0, 39, 25, 5, false},
            //lb1	色検知、左カーブ(右から右)
			{Section::VIRTUAL, 0, 0, {0, 0}, 8, 0, 0, 10, Section::TURNANGLE, 95, {0, 0}, BLUE, 0, 24, 25, 5, false},
            {Section::TRACER, 0, 0, {0, 0}, 8, 0, 0, 0, Section::LENGTH, 12, {0, 0}, BLUE, 0, 39, 25, 5, false},
