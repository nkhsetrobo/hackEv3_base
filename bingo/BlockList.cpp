...
void BlockList::initList()
{
    ...
    pass_list[14] =
    {
        {1.0,0.0},{2.0,1.0},2.0,SOUTH,
        {
            ...
            {Section::VIRTUAL, 0, 0, {0, 0}, 16, 0, 0, -24.5, Section::LENGTH, 22, {0, 0}, BLUE, 0, 23, 15, 3, false},
    ...
    pass_list[18] =
    {
        {1.0,0.0},{2.5,1.5},11.5,SOUTH,
        {
			...
			{Section::WALKER, 0, 0, {0,0}, 0, 0, 0, 0, Section::STOP, 50, {0,0}, BLUE, 0, 0, 0, 0, true},
			{Section::WALKER, -15, 0, {0,0}, 0, 0, 0, 0, Section::LENGTH, -5.9, {0,0}, BLUE, 0, 39, 25, 5, true},
