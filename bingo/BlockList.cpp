...
void BlockList::initList()
{
    ...
    pass_list[1] =
    {
        {1.0, 0.0},{0.0,1.0},10.0,WEST,
        {
            ...
            {Section::VIRTUAL, 0, 0, {0, 0}, 12, 0, 0, -9.8, Section::TURNANGLE, -83, {0, 0}, BLUE, 0, 24, 20, 3, false},
    ...
    pass_list[3] =
    {
        {1.0,0.0},{0.0,3.0},16.0,WEST,
        {
            ...
            {Section::WALKER, 22, 0, {0, 0}, 0, 0, 0, 0, Section::COLOR, 0, {1, 1}, BLUE, 0, 39, 25, 5, true},
            //li2	サークル突破(左)
            {Section::WALKER,25,0,{0,0},0,0,0,0,Section::LENGTH,13,{0,0},BLUE,0,0,0,0,true},
    ...
    pass_list[4] =
    {
        {1.0,0.0},{0.5,0.5},7.0,SOUTH,
        {
            ...
            {Section::VIRTUAL,0,0,{0,0},7,0,0,-8.5,Section::TURNANGLE,-180,{0,0},BLUE,0,15,8,5,false},
            ...
            {Section::WALKER,-10,0,{0,0},0,0,0,0,Section::LENGTH,-4,{0,0},BLUE,0,30,0.7,5,false},
            {Section::VIRTUAL,0,0,{0,0},-8,0,0,-4,Section::TURNANGLE,87,{0,0},BLUE,0,15,8,5,false},
            {Section::WALKER,-10,0,{0,0},0,0,0,0,Section::LENGTH,-6,{0,0},BLUE,0,30,0.7,5,false},
            {Section::WALKER,0,0,{0,0},0,0,0,0,Section::STOP,30,{0,0},BLUE,0,0,0,0,true},
            {Section::TRACER, 0, 0, {0,0}, 5, 0, 0, 0, Section::LENGTH, 8, {0,0}, BLUE, 0, 35, 25, 10.5, false },
    ...
    pass_list[5] =
    {
        {1.0,0.0},{0.5,1.5},9.0,SOUTH,
        {
			...
			{Section::VIRTUAL, 0, 0, {0,0}, 17, 0, 0, -17, Section::TURNANGLE, -51.5, {0,0}, BLUE, 0, 30, 25, 3, true},
			{Section::WALKER, 0, 0, {0,0}, 0, 0, 0, 0, Section::STOP, 50, {0,0}, BLUE, 0, 0, 0, 0, true},
			{Section::WALKER, -20, 0, {0,0}, 0, 0, 0, 0, Section::LENGTH, -5, {0,0}, BLUE, 0, 39, 25, 5, true},
            {Section::VIRTUAL, 0, 0, {0,0}, -16, 0, 0, -8.5, Section::TURNANGLE, 51.5, {0,0}, BLUE, 0, 35, 25, 3, false},
            {Section::VIRTUAL2, 0, 0, {0,0}, -13, 0, 0, 231.5, Section::LENGTH, -11.5, {0,0}, BLUE, 0, 39, 25, 7, true},
            {Section::WALKER, 0, 0, {0,0}, 0, 0, 0, 0, Section::STOP, 50, {0,0}, BLUE, 0, 0, 0, 0, true},
    ...
    pass_list[8] =
    {
        ...
        {
            //la1	色検知、右カーブ(右から右)
            {Section::VIRTUAL, 0, 0, {0,0}, 9, 0, 0, -8.5, Section::TURNANGLE, -80, {0,0}, BLUE, 0, 39, 25, 5, false},
    ...
    pass_list[9] =
    {
        ...
        {
            //la1	色検知、右カーブ(右から右)
            {Section::VIRTUAL, 0, 0, {0,0}, 12, 0, 0, -9.2, Section::TURNANGLE, -78, {0,0}, BLUE, 0, 39, 25, 5, false},
            //{Section::VIRTUAL, 0, 0, {0,0}, 5, 0, 0, 3, Section::TURNANGLE, 5, {0,0}, BLUE, 0, 39, 25, 5, false},
            {Section::TRACER, 0, 0, {0,0}, 16, 0, 0, 0, Section::LENGTH, 12, {0,0}, BLUE, 0, 39, 25, 5, false },
            {Section::WALKER, 22, 0, {0, 0}, 0, 0, 0, 0, Section::COLOR, 0, {1,1}, BLUE, 0, 39, 25, 5, false},
            //li1	サークル突破(右)
            {Section::WALKER,25,0,{0,0},0,0,0,0,Section::LENGTH,13,{0,0},BLUE,0,0,0,0,false},
            {Section::TRACER,0,0,{0,0},25,0,0,0,Section::LENGTH,15,{0,0},BLUE,0,30,0.7,5,false},
    ...
    pass_list[10] =
    {
        {1.0,0.0},{1.0,3.0},11.0,SOUTH,
        {
            ...
            {Section::VIRTUAL2, 0, 0, {0,0}, 35, 0, 0, 0, Section::LENGTH, 23, {0,0}, BLUE, 0, 39, 25, 5, true},
            {Section::TRACER, 0, 0, {0, 0}, 25, 0, 0, 0, Section::LENGTH, 10, {0,0}, BLUE, 0, 39, 0.7, 5, false},
    ...
    pass_list[11] =
    {
        {1.0,0.0},{1.5,0.5},4.0,EAST,
        {
            ...
            {Section::VIRTUAL, 0, 0, {0,0}, 16, 0, 0, -18, Section::TURNANGLE, -48.7, {0,0}, BLUE, 0, 30, 20, 3, true},
            {Section::WALKER, 0, 0, {0,0}, 0, 0, 0, 0, Section::STOP, 50, {0,0}, BLUE, 0, 0, 0, 0, true},
            {Section::WALKER, -15, 0, {0,0}, 0, 0, 0, 0, Section::LENGTH, -5, {0,0}, BLUE, 0, 39, 25, 5, true},
            {Section::VIRTUAL, 0, 0, {0,0}, -17, 0, 0, -14.5, Section::TURNANGLE, 48.7, {0,0}, BLUE, 0, 39, 25, 5, false},
            {Section::VIRTUAL2, 0, 0, {0,0}, -20, 0, 0, 228.7, Section::LENGTH, -8.5, {0,0}, BLUE, 0, 39, 25, 5, true},
            {Section::WALKER, 0, 0, {0,0}, 0, 0, 0, 0, Section::STOP, 50, {0,0}, BLUE, 0, 0, 0, 0, true},
            //{Section::TRACER, 0, 0, {0,0}, 20, 0, 0, 0, Section::LENGTH, 15, {0,0}, BLUE, 0, 39, 25, 5, false},
    ...
    pass_list[12] =
    {
        {1.0,0.0},{1.5,2.5},12.5,SOUTH,
        {
            ...
            {Section::WALKER, 12, 0, {0,0}, 10, 0, 0, 0, Section::LENGTH, 2, {0,0}, BLUE, 0, 39, 25, 5, true},
            {Section::VIRTUAL, 0, 0, {0, 0}, 12, 0, 0, -9.8, Section::TURNANGLE, -83, {0, 0}, BLUE, 0, 24, 20, 3, false},
            {Section::TRACER, 0, 0, {0, 0}, 16, 0, 0, 0, Section::LENGTH, 7, {0, 0}, BLUE, 0, 39, 25, 5, true},
            {Section::TRACER, 0, 0, {0, 0}, 22, 0, 0, 0, Section::LENGTH, 7, {0, 0}, BLUE, 0, 39, 25, 5, true},
            {Section::WALKER, 22, 0, {0, 0}, 0, 0, 0, 0, Section::COLOR, 0, {1, 0}, BLUE, 0, 39, 25, 5, true},
            //li2	サークル突破(左)
            {Section::WALKER,25,0,{0,0},0,0,0,0,Section::LENGTH,13,{0,0},BLUE,0,0,0,0,true},
            {Section::TRACER,0,0,{0,0},24,0,0,0,Section::LENGTH,15,{0,0},BLUE,0,30,0.7,5,true},
    ...
    pass_list[14] =
    {
        ...
        {
            //lc1	色未検知、右カーブ(右から右)
            {Section::WALKER, 22, 0, {0, 0}, 0, 0, 0, 0, Section::LENGTH, 13, {0, 0}, BLUE, 0, 0, 0, 0, false},
            {Section::TRACER, 0, 0, {0, 0}, 16, 0, 0, 0, Section::LENGTH, 5, {0, 0}, BLUE, 0, 20, 10, 3, false},
            {Section::VIRTUAL, 0, 0, {0, 0}, 16, 0, 0, -27.5, Section::LENGTH, 21, {0, 0}, BLUE, 0, 23, 15, 3, false},
            //{Section::VIRTUAL, 0, 0, {0, 0}, 10, 0, 0, -20, Section::TURNANGLE, -10, {0, 0}, BLUE, 0, 25, 20, 3, false},
            {Section::TRACER, 0, 0, {0, 0}, 9, 0, 0, 0, Section::LENGTH, 10, {0, 0}, BLUE, 0, 28, 15, 5, false},
            {Section::TRACER, 0, 0, {0, 0}, 15, 0, 0, 0, Section::LENGTH, 7, {0, 0}, BLUE, 0, 39, 15, 5, false},
    ...
    pass_list[15] =
    {
        {1.0,0.0},{2.0,2.0},2.0,SOUTH,
        {
            ...
            //li1	サークル突破(右)
            {Section::WALKER,25,0,{0,0},0,0,0,0,Section::LENGTH,13,{0,0},BLUE,0,0,0,0,false},
            {Section::TRACER,0,0,{0,0},26,0,0,0,Section::LENGTH,15,{0,0},BLUE,0,30,0.7,5,false},
    ...
    pass_list[17] =
    {
        {1.0,0.0},{2.5,0.5},7.0,EAST,
        {
            //li1	サークル突破(右)
            {Section::WALKER,25,0,{0,0},0,0,0,0,Section::LENGTH,13,{0,0},BLUE,0,0,0,0,false},
            {Section::TRACER,0,0,{0,0},24,0,0,0,Section::LENGTH,15,{0,0},BLUE,0,30,0.7,5,false},
            {Section::WALKER, 24, 0, {0, 0}, 0, 0, 0, 0, Section::COLOR,0,{2,0},BLUE,0,30,0.7,5,false},
            //le1	右ななめ(右から右)
            {Section::WALKER, 25, 0, {0,0}, 0, 0, 0, 0, Section::LENGTH, 5, {0,0}, BLUE, 0, 39, 25, 5, true}, 
            {Section::VIRTUAL, 0, 0, {0,0}, 16, 0, 0, -18, Section::TURNANGLE, -48.7, {0,0}, BLUE, 0, 30, 20, 3, true},
            {Section::WALKER, 0, 0, {0,0}, 0, 0, 0, 0, Section::STOP, 50, {0,0}, BLUE, 0, 0, 0, 0, true},
    ...
    pass_list[18] =
    {
        {1.0,0.0},{2.5,1.5},11.5,SOUTH,
        {
            ...
            //lf1	左ななめ(右から右)
			{Section::WALKER, 20, 0, {0,0}, 0, 0, 0, 0, Section::LENGTH, 5, {0,0}, BLUE, 0, 39, 25, 5, true},
			{Section::VIRTUAL, 0, 0, {0,0}, 16, 0, 0, 19, Section::TURNANGLE, 52, {0,0}, BLUE, 0, 30, 20, 3, true},
			{Section::WALKER, 0, 0, {0,0}, 0, 0, 0, 0, Section::STOP, 90, {0,0}, BLUE, 0, 0, 0, 0, true},
			{Section::WALKER, -15, 0, {0,0}, 0, 0, 0, 0, Section::LENGTH, -6, {0,0}, BLUE, 0, 39, 25, 5, true},
			{Section::VIRTUAL, 0, 0, {0,0}, -17, 0, 0, 11, Section::TURNANGLE, -52, {0,0}, BLUE, 0, 39, 25, 5, false},
    ...
    pass_list[19] =
    {
        {1.0,0.0},{2.5,2.5},14.5,SOUTH,
        {
            ...
            {Section::WALKER,25,0,{0,0},0,0,0,0,Section::LENGTH,13,{0,0},BLUE,0,0,0,0,false},
            {Section::TRACER,0,0,{0,0},25,0,0,0,Section::LENGTH,15,{0,0},BLUE,0,30,0.7,5,false},
            {Section::WALKER, 25, 0, {0, 0}, 0, 0, 0, 0, Section::COLOR,0,{2,2},BLUE,0,30,0.7,5,false},
            //lf1	左ななめ(右から右)
			{Section::WALKER, 22, 0, {0,0}, 0, 0, 0, 0, Section::LENGTH, 5, {0,0}, BLUE, 0, 39, 25, 5, true},
			{Section::VIRTUAL, 0, 0, {0,0}, 16, 0, 0, 19, Section::TURNANGLE, 52, {0,0}, BLUE, 0, 30, 20, 3, true},
			{Section::WALKER, 0, 0, {0,0}, 0, 0, 0, 0, Section::STOP, 90, {0,0}, BLUE, 0, 0, 0, 0, true},
			{Section::WALKER, -15, 0, {0,0}, 0, 0, 0, 0, Section::LENGTH, -6, {0,0}, BLUE, 0, 39, 25, 5, true},
			{Section::VIRTUAL, 0, 0, {0,0}, -17, 0, 0, 11, Section::TURNANGLE, -52, {0,0}, BLUE, 0, 39, 25, 5, false},
    ...
    pass_list[22] =
    {
        {1.0,0.0},{3.0,2.0},14.0,SOUTH,
        {
            ...
            {Section::TRACER, 0, 0, {0, 0}, 9, 0, 0, 0, Section::LENGTH, 10, {0, 0}, BLUE, 0, 28, 15, 5, false},
            {Section::TRACER, 0, 0, {0, 0}, 15, 0, 0, 0, Section::LENGTH, 7, {0, 0}, BLUE, 0, 39, 15, 5, false},
            {Section::WALKER, 24, 0, {0, 0}, 0, 0, 0, 0, Section::COLOR, 0, {3, 1}, BLUE, 0, 30, 0.7, 5},
            //li1	サークル突破(右)
            {Section::WALKER,25,0,{0,0},0,0,0,0,Section::LENGTH,13,{0,0},BLUE,0,0,0,0,false},
            {Section::TRACER,0,0,{0,0},24,0,0,0,Section::LENGTH,15,{0,0},BLUE,0,30,0.7,5,false},
    ...
    pass_list[23] =
    {
        {1.0,0.0},{3.0,3.0},17.0,SOUTH,
        {
            ...
            {Section::WALKER, 24, 0, {0, 0}, 0, 0, 0, 0, Section::COLOR,0,{2,0},BLUE,0,30,0.7,5,false},
            //lc1	色未検知、右カーブ(右から右)
            {Section::WALKER, 24, 0, {0, 0}, 0, 0, 0, 0, Section::LENGTH, 22, {0, 0}, BLUE, 0, 0, 0, 0, false},
            //{Section::VIRTUAL, 0, 0, {0, 0}, 15, 0, 0, -29, Section::LENGTH, -10, {0, 0}, BLUE, 0, 20, 10, 3, false},
            {Section::VIRTUAL, 0, 0, {0, 0}, 16, 0, 0, -25, Section::LENGTH, 19, {0, 0}, BLUE, 0, 23, 15, 3, false},
            //{Section::VIRTUAL, 0, 0, {0, 0}, 10, 0, 0, -20, Section::TURNANGLE, -10, {0, 0}, BLUE, 0, 25, 20, 3, false},
            {Section::TRACER, 0, 0, {0, 0}, 9, 0, 0, 0, Section::LENGTH, 10, {0, 0}, BLUE, 0, 39, 15, 5, false},
            {Section::TRACER, 0, 0, {0, 0}, 15, 0, 0, 0, Section::LENGTH, 7, {0, 0}, BLUE, 0, 39, 15, 5, false},
            {Section::WALKER, 24, 0, {0, 0}, 0, 0, 0, 0, Section::COLOR, 0, {3, 3}, BLUE, 0, 30, 0.7, 5},
            //li1	サークル突破(右)
            {Section::WALKER,25,0,{0,0},0,0,0,0,Section::LENGTH,13,{0,0},BLUE,0,0,0,0,false},
            {Section::TRACER,0,0,{0,0},25,0,0,0,Section::LENGTH,10,{0,0},BLUE,0,39,0.7,5,false},
            {Section::VIRTUAL, 0, 0, {0,0}, 28, 0, 0, 0, Section::TURNANGLE, 0, {0,0}, BLUE, 0, 39, 25, 5, true},
    ...
    pass_list[28] =
    {
		...
		{Section::WALKER,8,0,{0,0},0,0,0,0,Section::LENGTH,2,{0,0},BLUE,0,30,0.7,5,false},
            {Section::VIRTUAL,0,0,{0,0},5,0,0,9,Section::TURNANGLE,182,{0,0},BLUE,0,15,8,5,false},
	        {Section::WALKER,8,0,{0,0},0,0,0,0,Section::LENGTH,5.508,{0,0},BLUE,0,30,0.7,5,false},
            {Section::WALKER,0,0,{0,0},0,0,0,0,Section::STOP,30,{0,0},BLUE,0,0,0,0,true},
            {Section::WALKER,-10,0,{0,0},0,0,0,0,Section::LENGTH,-8.5,{0,0},BLUE,0,30,0.7,5,false},
            {Section::VIRTUAL,0,0,{0,0},-8.5,0,0,5,Section::TURNANGLE,-85,{0,0},BLUE,0,15,8,5,false},
            {Section::WALKER,0,0,{0,0},0,0,0,0,Section::STOP,30,{0,0},BLUE,0,0,0,0,true},
            {Section::TRACER,0,0,{0,0},5,0,0,0,Section::LENGTH,5,{0,0},BLUE,0,35,25,10.5,false},
    ...
    pass_list[34] =
    {
        {1.0,1.0},{1.0,3.0},8.0,SOUTH,
        {
            ...
            {Section::VIRTUAL, 0, 0, {0,0}, 5, 0, 0, 3, Section::TURNANGLE, 5, {0,0}, BLUE, 0, 39, 25, 5, false},
            {Section::WALKER, 24, 0, {0, 0}, 0, 0, 0, 0, Section::COLOR, 0, {1,2}, BLUE, 0, 39, 25, 5, false},
            //li1	サークル突破(右)
            {Section::WALKER,25,0,{0,0},0,0,0,0,Section::LENGTH,13,{0,0},BLUE,0,0,0,0,false},
            {Section::TRACER,0,0,{0,0},24,0,0,0,Section::LENGTH,15,{0,0},BLUE,0,30,0.7,5,false},
            {Section::WALKER, 22, 0, {0, 0}, 0, 0, 0, 0, Section::COLOR,0,{1,3},BLUE,0,30,0.7,5,false},
    ...
    pass_list[40] =
    {
        {1.0,1.0},{2.0,3.0},11.0,SOUTH,
        {
            ...
            {Section::TRACER, 0, 0, {0, 0}, 9, 0, 0, 0, Section::LENGTH, 10, {0, 0}, BLUE, 0, 28, 15, 5, false},
            {Section::TRACER, 0, 0, {0, 0}, 15, 0, 0, 0, Section::LENGTH, 7, {0, 0}, BLUE, 0, 39, 15, 5, false},
            {Section::WALKER, 24, 0, {0, 0}, 0, 0, 0, 0, Section::COLOR, 0, {2, 2}, BLUE, 0, 30, 0.7, 5},
            //li1	サークル突破(右)
            {Section::WALKER,25,0,{0,0},0,0,0,0,Section::LENGTH,13,{0,0},BLUE,0,0,0,0,false},
            {Section::TRACER,0,0,{0,0},24,0,0,0,Section::LENGTH,15,{0,0},BLUE,0,30,0.7,5,false},
            {Section::WALKER, 22, 0, {0, 0}, 0, 0, 0, 0, Section::COLOR,0,{2,3},BLUE,0,30,0.7,5,false},
    ...
    pass_list[41] =
    {
        {1.0,1.0},{2.5,0.5},7.5,EAST,
        {
            ...
            {Section::WALKER,25,0,{0,0},0,0,0,0,Section::LENGTH,13,{0,0},BLUE,0,0,0,0,false},
            {Section::TRACER,0,0,{0,0},24,0,0,0,Section::LENGTH,15,{0,0},BLUE,0,30,0.7,5,false},
            {Section::WALKER, 24, 0, {0, 0}, 0, 0, 0, 0, Section::COLOR,0,{2,1},BLUE,0,30,0.7,5,false},
            //lf1	左ななめ(右から右)
			{Section::WALKER, 22, 0, {0,0}, 0, 0, 0, 0, Section::LENGTH, 5, {0,0}, BLUE, 0, 39, 25, 5, true},
			{Section::VIRTUAL, 0, 0, {0,0}, 16, 0, 0, 19, Section::TURNANGLE, 52, {0,0}, BLUE, 0, 30, 20, 3, true},
			{Section::WALKER, 0, 0, {0,0}, 0, 0, 0, 0, Section::STOP, 90, {0,0}, BLUE, 0, 0, 0, 0, true},
    ...
    pass_list[43] =
    {
        {1.0,1.0},{2.5,2.5},12.5,SOUTH,
        {
            ...
            {Section::TRACER, 0, 0, {0, 0}, 24, 0, 0, 0, Section::LENGTH, 10, {0, 0}, BLUE, 0, 39, 25, 5, true},
            {Section::WALKER, 24, 0, {0, 0}, 0, 0, 0, 0, Section::COLOR, 0, {2, 2}, BLUE, 0, 39, 25, 5, true},
            //lf2	左ななめ(左から右)
			{Section::WALKER, 25, 0, {0,0}, 0, 0, 0, 0, Section::LENGTH, 5, {0,0}, BLUE, 0, 39, 25, 5, true}, 
            {Section::VIRTUAL, 0, 0, {0,0}, 14, 0, 0, 18, Section::TURNANGLE, 48.7, {0,0}, BLUE, 0, 30, 20, 3, true},
			{Section::WALKER, 0, 0, {0,0}, 0, 0, 0, 0, Section::STOP, 50, {0,0}, BLUE, 0, 0, 0, 0, true},
    ...
    pass_list[44] =
    {
        {1.0,1.0},{3.0,0.0},11.5,NORTH,
        {
            ...
            {Section::TRACER, 0, 0, {0, 0}, 9, 0, 0, 0, Section::LENGTH, 7, {0, 0}, BLUE, 0, 39, 25, 5, false},
            {Section::TRACER, 0, 0, {0, 0}, 15, 0, 0, 0, Section::LENGTH, 5, {0, 0}, BLUE, 0, 39, 25, 5, false},
    ...
    pass_list[47] =
    {
        {1.0,1.0},{3.0,3.0},14.0,SOUTH,
        {
            ...
            {Section::TRACER, 0, 0, {0, 0}, 9, 0, 0, 0, Section::LENGTH, 10, {0, 0}, BLUE, 0, 39, 15, 5, false},
            {Section::TRACER, 0, 0, {0, 0}, 15, 0, 0, 0, Section::LENGTH, 7, {0, 0}, BLUE, 0, 39, 15, 5, false},
            {Section::WALKER, 24, 0, {0, 0}, 0, 0, 0, 0, Section::COLOR, 0, {3, 2}, BLUE, 0, 30, 0.7, 5},
            //li1	サークル突破(右)
            {Section::WALKER,25,0,{0,0},0,0,0,0,Section::LENGTH,13,{0,0},BLUE,0,0,0,0,false},
            {Section::TRACER,0,0,{0,0},24,0,0,0,Section::LENGTH,15,{0,0},BLUE,0,30,0.7,5,false},
            {Section::WALKER, 22, 0, {0, 0}, 0, 0, 0, 0, Section::COLOR,0,{3,3},BLUE,0,30,0.7,5,false},
    ...
    pass_list[55] =
    {
        {1.0,2.0},{1.0,0.0},8.5,NORTH,
        {
            ...
            {Section::TRACER, 0, 0, {0, 0}, 12, 0, 0, 0, Section::LENGTH, 8, {0, 0}, BLUE, 0, 39, 25, 5, false},
			{Section::TRACER, 0, 0, {0, 0}, 15, 0, 0, 0, Section::LENGTH, 7, {0, 0}, BLUE, 0, 39, 25, 5, false},
            {Section::WALKER, 24, 0, {0, 0}, 0, 0, 0, 0, Section::COLOR, 0, {1, 1}, BLUE, 0, 39, 25, 5, false},
            //li1	サークル突破(右)
            {Section::WALKER,25,0,{0,0},0,0,0,0,Section::LENGTH,13,{0,0},BLUE,0,0,0,0,false},
            {Section::TRACER,0,0,{0,0},24,0,0,0,Section::LENGTH,15,{0,0},BLUE,0,30,0.7,5,false},
            {Section::WALKER, 22, 0, {0, 0}, 0, 0, 0, 0, Section::COLOR,0,{1,0},BLUE,0,30,0.7,5,false},
    ...
    pass_list[61] =
    {
        {1.0,2.0},{2.0,0.0},11.5,NORTH,
        {
            ...
            {Section::TRACER, 0, 0, {0, 0}, 9, 0, 0, 0, Section::LENGTH, 7, {0, 0}, BLUE, 0, 39, 25, 5, false},
            {Section::TRACER, 0, 0, {0, 0}, 15, 0, 0, 0, Section::LENGTH, 5, {0, 0}, BLUE, 0, 39, 25, 5, false},
            {Section::WALKER, 24, 0, {0, 0}, 0, 0, 0, 0, Section::COLOR, 0, {2, 1}, BLUE, 0, 39, 25, 5, false},
            //li1	サークル突破(右)
            {Section::WALKER,25,0,{0,0},0,0,0,0,Section::LENGTH,13,{0,0},BLUE,0,0,0,0,false},
            {Section::TRACER,0,0,{0,0},24,0,0,0,Section::LENGTH,15,{0,0},BLUE,0,30,0.7,5,false},
            {Section::WALKER, 22, 0, {0, 0}, 0, 0, 0, 0, Section::COLOR,0,{2,0},BLUE,0,30,0.7,5,false},
    ...
    pass_list[66] =
    {
        {1.0,2.0},{2.5,1.5},7.5,EAST,
        {
            ...
            {Section::WALKER,25,0,{0,0},0,0,0,0,Section::LENGTH,13,{0,0},BLUE,0,0,0,0,false},
            {Section::TRACER,0,0,{0,0},24,0,0,0,Section::LENGTH,15,{0,0},BLUE,0,30,0.7,5,false},
            {Section::WALKER, 24, 0, {0, 0}, 0, 0, 0, 0, Section::COLOR,0,{2,2},BLUE,0,30,0.7,5,false},
            //lf1	左ななめ(右から右)
			{Section::WALKER, 22, 0, {0,0}, 0, 0, 0, 0, Section::LENGTH, 5, {0,0}, BLUE, 0, 39, 25, 5, true},
			{Section::VIRTUAL, 0, 0, {0,0}, 16, 0, 0, 19, Section::TURNANGLE, 52, {0,0}, BLUE, 0, 30, 20, 3, true},
			{Section::WALKER, 0, 0, {0,0}, 0, 0, 0, 0, Section::STOP, 90, {0,0}, BLUE, 0, 0, 0, 0, true},
    ...
    pass_list[67] =
    {
        {1.0,2.0},{2.5,2.5},7.0,EAST,
        {
            ...
            {Section::WALKER,25,0,{0,0},0,0,0,0,Section::LENGTH,13,{0,0},BLUE,0,0,0,0,false},
            {Section::TRACER,0,0,{0,0},24,0,0,0,Section::LENGTH,15,{0,0},BLUE,0,30,0.7,5,false},
            {Section::WALKER, 24, 0, {0, 0}, 0, 0, 0, 0, Section::COLOR,0,{0,0},BLUE,0,30,0.7,5,false},
            //le1	右ななめ(右から右)
            {Section::WALKER, 25, 0, {0,0}, 0, 0, 0, 0, Section::LENGTH, 5, {0,0}, BLUE, 0, 39, 25, 5, true}, 
            {Section::VIRTUAL, 0, 0, {0,0}, 16, 0, 0, -18, Section::TURNANGLE, -48.7, {0,0}, BLUE, 0, 30, 20, 3, true},
            {Section::WALKER, 0, 0, {0,0}, 0, 0, 0, 0, Section::STOP, 50, {0,0}, BLUE, 0, 0, 0, 0, true},
    ...
    pass_list[68] =
    {
        {1.0,2.0},{3.0,0.0},14.5,NORTH,
        {
            ...
            {Section::TRACER, 0, 0, {0, 0}, 9, 0, 0, 0, Section::LENGTH, 7, {0, 0}, BLUE, 0, 39, 25, 5, false},
            {Section::TRACER, 0, 0, {0, 0}, 15, 0, 0, 0, Section::LENGTH, 5, {0, 0}, BLUE, 0, 39, 25, 5, false},
            {Section::WALKER, 24, 0, {0, 0}, 0, 0, 0, 0, Section::COLOR, 0, {3, 1}, BLUE, 0, 39, 25, 5, false},
            //li1	サークル突破(右)
            {Section::WALKER,25,0,{0,0},0,0,0,0,Section::LENGTH,13,{0,0},BLUE,0,0,0,0,false},
            {Section::TRACER,0,0,{0,0},24,0,0,0,Section::LENGTH,15,{0,0},BLUE,0,30,0.7,5,false},
            {Section::WALKER, 22, 0, {0, 0}, 0, 0, 0, 0, Section::COLOR,0,{3,0},BLUE,0,30,0.7,5,false},
    ...
    pass_list[76] =
    {
        {1.0,3.0},{0.5,0.5},13.0,NORTH,
        {
            ...
            {Section::WALKER,25,0,{0,0},0,0,0,0,Section::LENGTH,13,{0,0},BLUE,0,0,0,0,false},
            {Section::TRACER,0,0,{0,0},24,0,0,0,Section::LENGTH,15,{0,0},BLUE,0,30,0.7,5,false},
            {Section::WALKER, 24, 0, {0, 0}, 0, 0, 0, 0, Section::COLOR,0,{1,1},BLUE,0,30,0.7,5,false},
            //lf1	左ななめ(右から右)
			{Section::WALKER, 22, 0, {0,0}, 0, 0, 0, 0, Section::LENGTH, 5, {0,0}, BLUE, 0, 39, 25, 5, true},
			{Section::VIRTUAL, 0, 0, {0,0}, 16, 0, 0, 19, Section::TURNANGLE, 52, {0,0}, BLUE, 0, 30, 20, 3, true},
			{Section::WALKER, 0, 0, {0,0}, 0, 0, 0, 0, Section::STOP, 90, {0,0}, BLUE, 0, 0, 0, 0, true},
    ...
    pass_list[89] =
    {
        {1.0,3.0},{2.5,0.5},15.5,EAST,
        {
            ...
            {Section::TRACER, 0, 0, {0, 0}, 12, 0, 0, 0, Section::LENGTH, 8, {0, 0}, BLUE, 0, 39, 25, 5, false},
			{Section::TRACER, 0, 0, {0, 0}, 15, 0, 0, 0, Section::LENGTH, 7, {0, 0}, BLUE, 0, 39, 25, 5, false},
            {Section::WALKER, 24, 0, {0, 0}, 0, 0, 0, 0, Section::COLOR, 0, {2, 2}, BLUE, 0, 39, 25, 5, false},
            //li1	サークル突破(右)
            {Section::WALKER,25,0,{0,0},0,0,0,0,Section::LENGTH,13,{0,0},BLUE,0,0,0,0,false},
            {Section::TRACER,0,0,{0,0},24,0,0,0,Section::LENGTH,15,{0,0},BLUE,0,30,0.7,5,false},
            {Section::WALKER, 24, 0, {0, 0}, 0, 0, 0, 0, Section::COLOR,0,{2,1},BLUE,0,30,0.7,5,false},
    ...
    pass_list[92] =
    {
        {1.0,3.0},{3.0,0.0},17.5,NORTH,
        {
            ...
            {Section::WALKER,25,0,{0,0},0,0,0,0,Section::LENGTH,13,{0,0},BLUE,0,0,0,0,false},
            {Section::TRACER,0,0,{0,0},24,0,0,0,Section::LENGTH,15,{0,0},BLUE,0,30,0.7,5,false},
            {Section::WALKER, 24, 0, {0, 0}, 0, 0, 0, 0, Section::COLOR,0,{2,3},BLUE,0,30,0.7,5,false},
            //ld1	色未検知、左カーブ(右から右)
            {Section::WALKER, 25, 0, {0, 0}, 0, 0, 0, 0, Section::LENGTH, 21, {0, 0}, BLUE, 0, 0, 0, 0, false},
            {Section::VIRTUAL, 0, 0, {0, 0}, 12, 0, 0, 30, Section::TURNANGLE, 20, {0, 0}, BLUE, 0, 39, 25, 5, false},
            {Section::VIRTUAL, 0, 0, {0, 0}, 12, 0, 0, 30, Section::BRIGHTNESS, -0.5, {0, 0}, BLUE, 0, 39, 25, 5, false},
            ...
            {Section::TRACER, 0, 0, {0, 0}, 9, 0, 0, 0, Section::LENGTH, 7, {0, 0}, BLUE, 0, 39, 25, 5, false},
            {Section::TRACER, 0, 0, {0, 0}, 15, 0, 0, 0, Section::LENGTH, 5, {0, 0}, BLUE, 0, 39, 25, 5, false},
            {Section::WALKER, 24, 0, {0, 0}, 0, 0, 0, 0, Section::COLOR, 0, {3, 2}, BLUE, 0, 39, 25, 5, false},
    ...
    pass_list[96] =
    {
        {2.0,0.0},{0.0,0.0},15.0,WEST,
        {
            ...
            {Section::VIRTUAL,0,0,{0,0},1,0,0,3,Section::TURNANGLE,165,{0,0},BLUE,0,30,0.7,5,false},
            {Section::TRACER, 0, 0, {0,0}, 24, 0, 0, 0, Section::LENGTH, 12, {0,0}, BLUE, 0, 39, 25, 5, false },
            {Section::WALKER, 24, 0, {0, 0}, 0, 0, 0, 0, Section::COLOR,0,{1,0},BLUE,0,30,0.7,5,false},
            //li1	サークル突破(右)
            {Section::WALKER,25,0,{0,0},0,0,0,0,Section::LENGTH,13,{0,0},BLUE,0,0,0,0,false},
            {Section::TRACER,0,0,{0,0},24,0,0,0,Section::LENGTH,15,{0,0},BLUE,0,30,0.7,5,false},
            {Section::WALKER, 22, 0, {0, 0}, 0, 0, 0, 0, Section::COLOR,0,{0,0},BLUE,0,30,0.7,5,false},
    ...
    pass_list[99] =
    {
        {2.0,0.0},{0.0,3.0},19.0,WEST,
        {
            ...
            {Section::TRACER, 0, 0, {0, 0}, 12, 0, 0, 0, Section::LENGTH, 7, {0, 0}, BLUE, 0, 39, 25, 5, true},
            {Section::TRACER, 0, 0, {0, 0}, 18, 0, 0, 0, Section::LENGTH, 7, {0, 0}, BLUE, 0, 39, 25, 5, true},
            {Section::WALKER, 24, 0, {0, 0}, 0, 0, 0, 0, Section::COLOR, 0, {2, 1}, BLUE, 0, 39, 25, 5, true},
            //li2	サークル突破(左)
            {Section::WALKER,25,0,{0,0},0,0,0,0,Section::LENGTH,13,{0,0},BLUE,0,0,0,0,true},
            {Section::TRACER,0,0,{0,0},24,0,0,0,Section::LENGTH,15,{0,0},BLUE,0,30,0.7,5,true},
            {Section::WALKER, 24, 0, {0, 0}, 0, 0, 0, 0, Section::COLOR,0,{2,2},BLUE,0,30,0.7,5,true},
            //lc3	色未検知、右カーブ(左から右)
            {Section::WALKER, 25, 0, {0, 0}, 0, 0, 0, 0, Section::LENGTH, 13, {0, 0}, BLUE, 0, 0, 0, 0, false},
            {Section::VIRTUAL, 0, 0, {0, 0}, 20, 0, 0, -26, Section::TURNANGLE, -30, {0, 0}, BLUE, 0, 39, 25, 5, false},
            {Section::VIRTUAL, 0, 0, {0, 0}, 13, 0, 0, -26, Section::BRIGHTNESS, -0.5, {0, 0}, BLUE, 0, 39, 25, 5, false},
            {Section::VIRTUAL, 0, 0, {0, 0}, 13, 0, 0, -0.5, Section::TURNANGLE, -40, {0, 0}, BLUE, 0, 39, 25, 5, false},
            {Section::TRACER, 0, 0, {0, 0}, 24, 0, 0, 0, Section::LENGTH, 10, {0, 0}, BLUE, 0, 39, 25, 5, true},
            {Section::WALKER, 24, 0, {0, 0}, 0, 0, 0, 0, Section::COLOR, 0, {1, 3}, BLUE, 0, 39, 25, 5, false},
            //li1	サークル突破(右)
            {Section::WALKER,25,0,{0,0},0,0,0,0,Section::LENGTH,13,{0,0},BLUE,0,0,0,0,false},
            {Section::TRACER,0,0,{0,0},24,0,0,0,Section::LENGTH,15,{0,0},BLUE,0,30,0.7,5,false},
            {Section::WALKER, 22, 0, {0, 0}, 0, 0, 0, 0, Section::COLOR,0,{0,3},BLUE,0,30,0.7,5,false},
...
{Section::VIRTUAL, -1, 0, {0, 0}, 0, 0, 0, 0, Section::LENGTH, 0, {0, 0}, BLUE, 0, 0, 0, 0, false}
    ...
    pass_list[120] =
    {
        {2.0,1.0},{0.0,0.0},14.0,WEST,
        {
            ...
            {Section::TRACER, 0, 0, {0, 0}, 12, 0, 0, 0, Section::LENGTH, 8, {0, 0}, BLUE, 0, 39, 25, 5, false},
			{Section::TRACER, 0, 0, {0, 0}, 15, 0, 0, 0, Section::LENGTH, 7, {0, 0}, BLUE, 0, 39, 25, 5, false},
            {Section::WALKER, 24, 0, {0, 0}, 0, 0, 0, 0, Section::COLOR, 0, {1, 0}, BLUE, 0, 39, 25, 5, false},
            //li1	サークル突破(右)
            {Section::WALKER,25,0,{0,0},0,0,0,0,Section::LENGTH,13,{0,0},BLUE,0,0,0,0,false},
            {Section::TRACER,0,0,{0,0},24,0,0,0,Section::LENGTH,15,{0,0},BLUE,0,30,0.7,5,false},
            {Section::WALKER, 22, 0, {0, 0}, 0, 0, 0, 0, Section::COLOR,0,{0,0},BLUE,0,30,0.7,5,false},
    ...
    pass_list[191] =
    {
        {2.0,3.0},{3.0,3.0},3.0,EAST,
        {
            ...
            {Section::WALKER,25,0,{0,0},0,0,0,0,Section::LENGTH,13,{0,0},BLUE,0,0,0,0,false},
            {Section::TRACER,0,0,{0,0},24,0,0,0,Section::LENGTH,15,{0,0},BLUE,0,30,0.7,5,false},
            {Section::WALKER, 24, 0, {0, 0}, 0, 0, 0, 0, Section::COLOR,0,{3,3},BLUE,0,30,0.7,5,false},
            //終わり
            {Section::VIRTUAL, -1, 0, {0, 0}, 0, 0, 0, 0, Section::LENGTH, 0, {0, 0}, BLUE, 0, 0, 0, 0, false}
    ...
    pass_list[195] =
    {
        {3.0,0.0},{0.0,3.0},22.0,WEST,
        {
            ...
            {Section::VIRTUAL, 0, 0, {0, 0}, 13, 0, 0, -0.5, Section::TURNANGLE, -40, {0, 0}, BLUE, 0, 39, 25, 5, false},
            {Section::TRACER, 0, 0, {0, 0}, 24, 0, 0, 0, Section::LENGTH, 10, {0, 0}, BLUE, 0, 39, 25, 5, true},
            {Section::WALKER, 24, 0, {0, 0}, 0, 0, 0, 0, Section::COLOR, 0, {2, 3}, BLUE, 0, 39, 25, 5, false},
            //li1	サークル突破(右)
            {Section::WALKER,25,0,{0,0},0,0,0,0,Section::LENGTH,13,{0,0},BLUE,0,0,0,0,false},
            {Section::TRACER,0,0,{0,0},25,0,0,0,Section::LENGTH,10,{0,0},BLUE,0,39,0.7,5,false},
            {Section::VIRTUAL, 0, 0, {0,0}, 28, 0, 0, 0, Section::TURNANGLE, 0, {0,0}, BLUE, 0, 39, 25, 5, true},
    ...
    pass_list[196] =
    {
        {3.0,0.0},{0.5,0.5},17.0,WEST,
        {
			...
			{Section::WALKER, 0, 0, {0,0}, 0, 0, 0, 0, Section::STOP, 50, {0,0}, BLUE, 0, 0, 0, 0, true},
			{Section::WALKER, -20, 0, {0,0}, 0, 0, 0, 0, Section::LENGTH, -5, {0,0}, BLUE, 0, 39, 25, 5, true},
            {Section::VIRTUAL, 0, 0, {0,0}, -16, 0, 0, -9.5, Section::TURNANGLE, 51.5, {0,0}, BLUE, 0, 30, 25, 3, false},
            {Section::VIRTUAL2, 0, 0, {0,0}, -13, 0, 0, 231.5, Section::LENGTH, -10, {0,0}, BLUE, 0, 39, 25, 7, true},
            {Section::WALKER, 0, 0, {0,0}, 0, 0, 0, 0, Section::STOP, 50, {0,0}, BLUE, 0, 0, 0, 0, true},
            //{Section::TRACER, 0, 0, {0,0}, 20, 0, 0, 0, Section::LENGTH, 15, {0,0}, BLUE, 0, 39, 25, 5, false},
            {Section::WALKER, 22, 0, {0, 0}, 0, 0, 0, 0, Section::COLOR, 0, {1,1}, BLUE, 0, 39, 25, 5, false},
            //終了
    ...
    pass_list[197] =
    {
        {3.0,0.0},{0.5,1.5},17.5,WEST,
        {
            ...
            {Section::WALKER,25,0,{0,0},0,0,0,0,Section::LENGTH,13,{0,0},BLUE,0,0,0,0,true},
            {Section::TRACER,0,0,{0,0},24,0,0,0,Section::LENGTH,15,{0,0},BLUE,0,30,0.7,5,true},
            {Section::WALKER, 24, 0, {0, 0}, 0, 0, 0, 0, Section::COLOR,0,{1,1},BLUE,0,30,0.7,5,true},
            //lf2	左ななめ(左から右)
			{Section::WALKER, 25, 0, {0,0}, 0, 0, 0, 0, Section::LENGTH, 5, {0,0}, BLUE, 0, 39, 25, 5, true}, 
            {Section::VIRTUAL, 0, 0, {0,0}, 14, 0, 0, 18, Section::TURNANGLE, 48.7, {0,0}, BLUE, 0, 30, 20, 3, true},
			{Section::WALKER, 0, 0, {0,0}, 0, 0, 0, 0, Section::STOP, 50, {0,0}, BLUE, 0, 0, 0, 0, true},
    ...
    pass_list[202] =
    {
        {3.0,0.0},{1.0,3.0},19.0,WEST,
        {
            ...
            {Section::TRACER, 0, 0, {0, 0}, 12, 0, 0, 0, Section::LENGTH, 7, {0, 0}, BLUE, 0, 39, 25, 5, true},
            {Section::TRACER, 0, 0, {0, 0}, 18, 0, 0, 0, Section::LENGTH, 7, {0, 0}, BLUE, 0, 39, 25, 5, true},
            {Section::WALKER, 24, 0, {0, 0}, 0, 0, 0, 0, Section::COLOR, 0, {3, 1}, BLUE, 0, 39, 25, 5, true},
            //li2	サークル突破(左)
            {Section::WALKER,25,0,{0,0},0,0,0,0,Section::LENGTH,13,{0,0},BLUE,0,0,0,0,true},
            {Section::TRACER,0,0,{0,0},24,0,0,0,Section::LENGTH,15,{0,0},BLUE,0,30,0.7,5,true},
            {Section::WALKER, 24, 0, {0, 0}, 0, 0, 0, 0, Section::COLOR,0,{3,2},BLUE,0,30,0.7,5,true},
            //lc3	色未検知、右カーブ(左から右)
            {Section::WALKER, 25, 0, {0, 0}, 0, 0, 0, 0, Section::LENGTH, 13, {0, 0}, BLUE, 0, 0, 0, 0, false},
            {Section::VIRTUAL, 0, 0, {0, 0}, 20, 0, 0, -26, Section::TURNANGLE, -30, {0, 0}, BLUE, 0, 39, 25, 5, false},
            {Section::VIRTUAL, 0, 0, {0, 0}, 13, 0, 0, -26, Section::BRIGHTNESS, -0.5, {0, 0}, BLUE, 0, 39, 25, 5, false},
    ...
    pass_list[216] =
    {
        {3.0,1.0},{0.0,0.0},17.0,WEST,
        {
            ...
            {Section::TRACER, 0, 0, {0, 0}, 12, 0, 0, 0, Section::LENGTH, 8, {0, 0}, BLUE, 0, 39, 25, 5, false},
			{Section::TRACER, 0, 0, {0, 0}, 15, 0, 0, 0, Section::LENGTH, 7, {0, 0}, BLUE, 0, 39, 25, 5, false},
            {Section::WALKER, 24, 0, {0, 0}, 0, 0, 0, 0, Section::COLOR, 0, {0, 2}, BLUE, 0, 39, 25, 5, false},
            //li1	サークル突破(右)
            {Section::WALKER,25,0,{0,0},0,0,0,0,Section::LENGTH,13,{0,0},BLUE,0,0,0,0,false},
            {Section::TRACER,0,0,{0,0},25,0,0,0,Section::LENGTH,10,{0,0},BLUE,0,39,0.7,5,false},
            {Section::VIRTUAL, 0, 0, {0,0}, 28, 0, 0, 0, Section::TURNANGLE, 0, {0,0}, BLUE, 0, 39, 25, 5, true},
    ...
    pass_list[222] =
    {
        {3.0,1.0},{0.5,2.5},17.5,WEST,
        {
            ...
            {Section::WALKER,25,0,{0,0},0,0,0,0,Section::LENGTH,13,{0,0},BLUE,0,0,0,0,true},
            {Section::TRACER,0,0,{0,0},24,0,0,0,Section::LENGTH,15,{0,0},BLUE,0,30,0.7,5,true},
            {Section::WALKER, 24, 0, {0, 0}, 0, 0, 0, 0, Section::COLOR,0,{1,2},BLUE,0,30,0.7,5,true},
            //lf2	左ななめ(左から右)
			{Section::WALKER, 25, 0, {0,0}, 0, 0, 0, 0, Section::LENGTH, 5, {0,0}, BLUE, 0, 39, 25, 5, true}, 
            {Section::VIRTUAL, 0, 0, {0,0}, 14, 0, 0, 18, Section::TURNANGLE, 48.7, {0,0}, BLUE, 0, 30, 20, 3, true},
			{Section::WALKER, 0, 0, {0,0}, 0, 0, 0, 0, Section::STOP, 50, {0,0}, BLUE, 0, 0, 0, 0, true},
...
//lh1	左uターン(右から右)
            {Section::WALKER,0,0,{0,0},0,0,0,0,Section::STOP,30,{0,0},BLUE,0,0,0,0,true},
		    {Section::WALKER,8,0,{0,0},0,0,0,0,Section::LENGTH,2,{0,0},BLUE,0,30,0.7,5,false},
            {Section::VIRTUAL,0,0,{0,0},7,0,0,8.5,Section::TURNANGLE,182,{0,0},BLUE,0,15,8,5,false},
	        {Section::WALKER,8,0,{0,0},0,0,0,0,Section::LENGTH,4,{0,0},BLUE,0,30,0.7,5,false},
            {Section::WALKER,0,0,{0,0},0,0,0,0,Section::STOP,30,{0,0},BLUE,0,0,0,0,true},
            {Section::WALKER,-10,0,{0,0},0,0,0,0,Section::LENGTH,-7.5,{0,0},BLUE,0,30,0.7,5,false},
            {Section::VIRTUAL,0,0,{0,0},-8.5,0,0,4,Section::TURNANGLE,-81,{0,0},BLUE,0,15,8,5,false},
            {Section::WALKER,0,0,{0,0},0,0,0,0,Section::STOP,30,{0,0},BLUE,0,0,0,0,true},
            {Section::TRACER,0,0,{0,0},5,0,0,0,Section::LENGTH,5,{0,0},BLUE,0,35,25,10.5,false},
    ...
    pass_list[240] =
    {
        {3.0,2.0},{0.0,0.0},20.0,WEST,
        {
            ...
            {Section::TRACER, 0, 0, {0, 0}, 9, 0, 0, 0, Section::LENGTH, 7, {0, 0}, BLUE, 0, 39, 25, 5, false},
            {Section::TRACER, 0, 0, {0, 0}, 15, 0, 0, 0, Section::LENGTH, 5, {0, 0}, BLUE, 0, 39, 25, 5, false},
            {Section::WALKER, 24, 0, {0, 0}, 0, 0, 0, 0, Section::COLOR, 0, {2, 0}, BLUE, 0, 39, 25, 5, false},
            //li1	サークル突破(右)
            {Section::WALKER,25,0,{0,0},0,0,0,0,Section::LENGTH,13,{0,0},BLUE,0,0,0,0,false},
            {Section::TRACER,0,0,{0,0},25,0,0,0,Section::LENGTH,10,{0,0},BLUE,0,39,0.7,5,false},
            {Section::VIRTUAL, 0, 0, {0,0}, 28, 0, 0, 0, Section::TURNANGLE, 0, {0,0}, BLUE, 0, 39, 25, 5, true},
    ...
    pass_list[264] =
    {
        {3.0,3.0},{0.0,0.0},23.0,WEST,
        {
            ...
            {Section::WALKER,25,0,{0,0},0,0,0,0,Section::LENGTH,13,{0,0},BLUE,0,0,0,0,false},
            {Section::TRACER,0,0,{0,0},24,0,0,0,Section::LENGTH,15,{0,0},BLUE,0,30,0.7,5,false},
            {Section::WALKER, 24, 0, {0, 0}, 0, 0, 0, 0, Section::COLOR,0,{3,1},BLUE,0,30,0.7,5,false},
            //ld1	色未検知、左カーブ(右から右)
            {Section::WALKER, 25, 0, {0, 0}, 0, 0, 0, 0, Section::LENGTH, 21, {0, 0}, BLUE, 0, 0, 0, 0, false},
            {Section::VIRTUAL, 0, 0, {0, 0}, 12, 0, 0, 30, Section::TURNANGLE, 20, {0, 0}, BLUE, 0, 39, 25, 5, false},
            {Section::VIRTUAL, 0, 0, {0, 0}, 12, 0, 0, 30, Section::BRIGHTNESS, -0.5, {0, 0}, BLUE, 0, 39, 25, 5, false},
    ...
    pass_list[269] =
    {
        {3.0,3.0},{0.5,1.5},18.0,WEST,
        {
            ...
            {Section::WALKER,25,0,{0,0},0,0,0,0,Section::LENGTH,13,{0,0},BLUE,0,0,0,0,false},
            {Section::TRACER,0,0,{0,0},24,0,0,0,Section::LENGTH,15,{0,0},BLUE,0,30,0.7,5,false},
            {Section::WALKER, 24, 0, {0, 0}, 0, 0, 0, 0, Section::COLOR,0,{1, 2},BLUE,0,30,0.7,5,false},
            //le1	右ななめ(右から右)
            {Section::WALKER, 25, 0, {0,0}, 0, 0, 0, 0, Section::LENGTH, 5, {0,0}, BLUE, 0, 39, 25, 5, true}, 
            {Section::VIRTUAL, 0, 0, {0,0}, 16, 0, 0, -18, Section::TURNANGLE, -48.7, {0,0}, BLUE, 0, 30, 20, 3, true},
            {Section::WALKER, 0, 0, {0,0}, 0, 0, 0, 0, Section::STOP, 50, {0,0}, BLUE, 0, 0, 0, 0, true},
