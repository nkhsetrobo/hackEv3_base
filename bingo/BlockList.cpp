...
void BlockList::initList()
{
    ...
    pass_list[24] =
    {
        ...
        {
            //lb1	色検知、左カーブ(右から右)
            {Section::WALKER, 5, 0, {0, 0}, 0, 0, 0, 0, Section::LENGTH, 2, {0, 0}, BLUE, 0, 30, 0.7, 5, false},
			{Section::VIRTUAL, 0, 0, {0, 0}, 5, 0, 0, 7, Section::TURNANGLE, 90, {0, 0}, BLUE, 0, 10, 0.7, 3, false},
			{Section::TRACER, 0, 0, {0, 0}, 10, 0, 0, 0, Section::LENGTH, 17, {0, 0}, BLUE, 0, 30, 0.7, 5, false},
            {Section::WALKER, 20, 0, {0, 0}, 0, 0, 0, 0, Section::COLOR, 0, {1, 0}, BLUE, 0, 30, 0.7, 5, false},
            //lb1	色検知、左カーブ(右から右)
            {Section::WALKER, 5, 0, {0, 0}, 0, 0, 0, 0, Section::LENGTH, 2, {0, 0}, BLUE, 0, 30, 0.7, 5, false},
			{Section::VIRTUAL, 0, 0, {0, 0}, 5, 0, 0, 7, Section::TURNANGLE, 90, {0, 0}, BLUE, 0, 10, 0.7, 3, false},
    ...
    pass_list[35] =
    {
        ...
        {
            //lf1	左ななめ(右から右)
			{Section::WALKER, 20, 0, {0,0}, 10, 0, 0, 0, Section::LENGTH, 3, {0,0}, BLUE, 0, 30, 0.7, 5, true},
			{Section::VIRTUAL, 0, 0, {0,0}, 20, 0, 0, 19.5, Section::LENGTH, 16, {0,0}, BLUE, 0, 15, 0.7, 5, true},
			{Section::VIRTUAL2, 0, 0, {0,0}, 0, 0, 0, 0, Section::STOP, 50, {0,0}, BLUE, 0, 0, 0, 0, true},
			{Section::WALKER, -10, 0, {0,0}, 0, 0, 0, 0, Section::LENGTH, -5, {0,0}, BLUE, 0, 30, 0.7, 5, true},
			{Section::VIRTUAL, 0, 0, {0,0}, -15, 0, 0, 13.5, Section::TURNANGLE, -49, {0,0}, BLUE, 0, 30, 0.7, 5, false},
			{Section::WALKER, -15, 0, {0,0}, 0, 0, 0, 0, Section::LENGTH, -15, {0,0}, BLUE, 0, 30, 0.7, 5, true},
			{Section::VIRTUAL2, 0, 0, {0,0}, 0, 0, 0, 0, Section::STOP, 50, {0,0}, BLUE, 0, 0, 0, 0, true},
            {Section::TRACER, 0, 0, {0, 0}, 7, 0, 0, 0, Section::LENGTH, 5, {0,0}, BLUE, 0, 30, 0.7, 5, false},
            {Section::WALKER, 20, 0, {0, 0}, 0, 0, 0, 0, Section::COLOR, 0, {1,1}, BLUE, 0, 30, 0.7, 5, false},
            //終了
            {Section::VIRTUAL,-1,0,{0,0},0,0,0,0,Section::TURNANGLE,0,{0,0},BLUE,0,0,0,0,true}
