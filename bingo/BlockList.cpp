...
void BlockList::initList()
{
    ...
    pass_list[13] =
    {
        {1.0,0.0},{2.0,0.0},3.0,EAST,
        {
            ...
            {Section::VIRTUAL2, 0, 0, {0,0}, -15, 0, 0, 228.7, Section::LENGTH, -9.2, {0,0}, BLUE, 0, 39, 25, 5, true},
            {Section::WALKER, 0, 0, {0,0}, 0, 0, 0, 0, Section::STOP, 50, {0,0}, BLUE, 0, 0, 0, 0, true},
    ...
    pass_list[14] =
    {
        {1.0,0.0},{2.0,1.0},2.0,SOUTH,
        {
            ...
            {Section::VIRTUAL, 0, 0, {0, 0}, 13, 0, 0, -0.5, Section::TURNANGLE, -18, {0, 0}, BLUE, 0, 39, 25, 5, false},
            {Section::TRACER, 0, 0, {0, 0}, 10, 0, 0, 0, Section::LENGTH, 14, {0, 0}, BLUE, 0, 39, 25, 5, true},
    ...
    pass_list[24] =
    {
        ...
        {
            //lb1	色検知、左カーブ(右から右)
            {Section::WALKER, 12, 0, {0,0}, 10, 0, 0, 0, Section::LENGTH, 4, {0,0}, BLUE, 0, 39, 25, 5, true},
