...
void BlockList::initList()
{
    ...
    pass_list[13] =
    {
        {1.0,0.0},{2.0,0.0},3.0,EAST,
        {
            ...
            {Section::WALKER, -15, 0, {0,0}, 0, 0, 0, 0, Section::LENGTH, -14, {0,0}, BLUE, 0, 39, 25, 5, true},
            {Section::VIRTUAL2, 0, 0, {0,0}, 0, 0, 0, 0, Section::STOP, 50, {0,0}, BLUE, 0, 0, 0, 0, true},
    ...
    pass_list[18] =
    {
        {1.0,0.0},{2.5,1.5},12.5,SOUTH,
        {
            ...
            {Section::WALKER, 15, 0, {0, 0}, 0, 0, 0, 0, Section::COLOR, 0, {2, 1}, BLUE, 0, 30, 0.7, 5},
            //lf1	左ななめ(右から右)
			{Section::WALKER, 15, 0, {0,0}, 10, 0, 0, 0, Section::LENGTH, 2, {0,0}, BLUE, 0, 39, 25, 5, true},
			{Section::VIRTUAL, 0, 0, {0,0}, 15, 0, 0, 17.5, Section::TURNANGLE, 52, {0,0}, BLUE, 0, 15, 0.7, 5, true},
			{Section::VIRTUAL2, 0, 0, {0,0}, 0, 0, 0, 0, Section::STOP, 50, {0,0}, BLUE, 0, 0, 0, 0, true},
			{Section::WALKER, -10, 0, {0,0}, 0, 0, 0, 0, Section::LENGTH, -5, {0,0}, BLUE, 0, 39, 25, 5, true},
			{Section::VIRTUAL, 0, 0, {0,0}, -10, 0, 0, 11, Section::TURNANGLE, -53, {0,0}, BLUE, 0, 39, 25, 5, false},
    ...
    pass_list[24] =
    {
        ...
        {
            //lb1	色検知、左カーブ(右から右)
			{Section::VIRTUAL, 0, 0, {0, 0}, 12, 0, 0, 10, Section::TURNANGLE, 90, {0, 0}, BLUE, 0, 24, 25, 5, false},
            {Section::TRACER, 0, 0, {0, 0}, 12, 0, 0, 0, Section::LENGTH, 12, {0, 0}, BLUE, 0, 39, 25, 5, false},
			{Section::TRACER, 0, 0, {0, 0}, 18, 0, 0, 0, Section::LENGTH, 8, {0, 0}, BLUE, 0, 39, 25, 5, false},
            {Section::WALKER, 15, 0, {0, 0}, 0, 0, 0, 0, Section::COLOR, 0, {1, 0}, BLUE, 0, 39, 25, 5, false},
            //lb1	色検知、左カーブ(右から右)
			{Section::VIRTUAL, 0, 0, {0, 0}, 12, 0, 0, 10, Section::TURNANGLE, 90, {0, 0}, BLUE, 0, 24, 25, 5, false},
            {Section::TRACER, 0, 0, {0, 0}, 12, 0, 0, 0, Section::LENGTH, 12, {0, 0}, BLUE, 0, 39, 25, 5, false},
