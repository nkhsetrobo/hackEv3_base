...
void BlockList::initList()
{
    ...
    pass_list[4] =
    {
        {1.0,0.0},{0.5,0.5},7.0,SOUTH,
        {
            ...
            {Section::VIRTUAL,0,0,{0,0},-7,0,0,-4,Section::TURNANGLE,73,{0,0},BLUE,0,15,8,5,false},
            {Section::WALKER,0,0,{0,0},0,0,0,0,Section::STOP,30,{0,0},BLUE,0,0,0,0,true},
            {Section::TRACER, 0, 0, {0,0}, 20, 0, 0, 0, Section::LENGTH, 8, {0,0}, BLUE, 0, 39, 25, 5, false },
    ...
    pass_list[8] =
    {
        ...
        {
            //la1	色検知、右カーブ(右から右)
            {Section::VIRTUAL, 0, 0, {0,0}, 5, 0, 0, -9, Section::TURNANGLE, -87, {0,0}, BLUE, 0, 39, 25, 5, false},
            //{Section::VIRTUAL, 0, 0, {0,0}, 5, 0, 0, 3, Section::TURNANGLE, 5, {0,0}, BLUE, 0, 39, 25, 5, false},
            {Section::TRACER, 0, 0, {0,0}, 20, 0, 0, 0, Section::LENGTH, 12, {0,0}, BLUE, 0, 39, 25, 5, false },
    ...
    pass_list[10] =
    {
        {1.0,0.0},{1.0,3.0},11.0,SOUTH,
        {
            ...
            //li1	サークル突破(右)
            {Section::WALKER,25,0,{0,0},0,0,0,0,Section::LENGTH,10,{0,0},BLUE,0,0,0,0,false},
            {Section::TRACER,0,0,{0,0},25,0,0,0,Section::LENGTH,10,{0,0},BLUE,0,30,0.7,5,false},
    ...
    pass_list[14] =
    {
        ...
        {
            //lc1	色未検知、右カーブ(右から右)
            {Section::WALKER, 20, 0, {0, 0}, 0, 0, 0, 0, Section::LENGTH, 17.5, {0, 0}, BLUE, 0, 0, 0, 0, false},
            {Section::VIRTUAL, 0, 0, {0, 0}, 10, 0, 0, -29, Section::LENGTH, 22.5, {0, 0}, BLUE, 0, 20, 10, 3, false},
    ...
    pass_list[44] =
    {
        {1.0,1.0},{3.0,0.0},11.5,NORTH,
        {
            ...
            {Section::WALKER, 15, 0, {0, 0}, 0, 0, 0, 0, Section::COLOR,0,{2,1},BLUE,0,30,0.7,5,false},
            //ld1	色未検知、左カーブ(右から右)
            {Section::WALKER, 20, 0, {0, 0}, 0, 0, 0, 0, Section::LENGTH, 21, {0, 0}, BLUE, 0, 0, 0, 0, false},
            {Section::VIRTUAL, 0, 0, {0, 0}, 12, 0, 0, 33, Section::TURNANGLE, 20, {0, 0}, BLUE, 0, 39, 25, 5, false},
            {Section::VIRTUAL, 0, 0, {0, 0}, 12, 0, 0, 33, Section::BRIGHTNESS, -0.5, {0, 0}, BLUE, 0, 39, 25, 5, false},
