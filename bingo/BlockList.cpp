...
void BlockList::initList()
{
    ...
    pass_list[14] =
    {
        ...
        {
            //lc1	色未検知、右カーブ(右から右)
            {Section::WALKER, 25, 0, {0, 0}, 0, 0, 0, 0, Section::LENGTH, 19, {0, 0}, BLUE, 0, 0, 0, 0, false},
            //{Section::VIRTUAL, 0, 0, {0, 0}, 15, 0, 0, -29, Section::LENGTH, -10, {0, 0}, BLUE, 0, 20, 10, 3, false},
            {Section::VIRTUAL, 0, 0, {0, 0}, 20, 0, 0, -24.5, Section::LENGTH, 23, {0, 0}, BLUE, 0, 28, 20, 3, false},
