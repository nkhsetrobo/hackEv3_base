...
void BlockList::initList()
{
    ...
    pass_list[10] =
    {
        {1.0,0.0},{1.0,3.0},11.0,SOUTH,
        {
            ...
            {Section::VIRTUAL2, 0, 0, {0,0}, 28, 0, 0, 0, Section::LENGTH, 40, {0,0}, BLUE, 0, 39, 25, 5, true},
    ...
    pass_list[14] =
    {
        {1.0,0.0},{2.0,1.0},2.0,SOUTH,
        {
            ...
            {Section::VIRTUAL, 0, 0, {0, 0}, 10, 0, 0, -29, Section::LENGTH, 23, {0, 0}, BLUE, 0, 30, 10, 3, false},
