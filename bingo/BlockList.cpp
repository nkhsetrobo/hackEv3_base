...
void BlockList::initList()
{
    ...
    pass_list[14] =
    {
        {1.0,0.0},{2.0,1.0},2.0,SOUTH,
        {
            ...
            {Section::VIRTUAL, 0, 0, {0, 0}, 13, 0, 0, -0.5, Section::TURNANGLE, -10, {0, 0}, BLUE, 0, 39, 25, 5, false},
            {Section::TRACER, 0, 0, {0, 0}, 5, 0, 0, 0, Section::LENGTH, 7, {0, 0}, BLUE, 0, 39, 25, 5, false},
    ...
    pass_list[24] =
    {
        {1.0,1.0},{0.0,0.0},11.0,WEST,
        {
			...
			{Section::VIRTUAL, 0, 0, {0, 0}, 12, 0, 0, 11, Section::TURNANGLE, 83, {0, 0}, BLUE, 0, 24, 25, 3, false},
