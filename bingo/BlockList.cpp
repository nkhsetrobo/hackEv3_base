...
void BlockList::initList()
{
    ...
    pass_list[4] =
    {
        {1.0,0.0},{0.5,0.5},7.0,SOUTH,
        {
            ...
            {Section::VIRTUAL,0,0,{0,0},-7,0,0,-4,Section::TURNANGLE,85,{0,0},BLUE,0,15,8,5,false},
    ...
    pass_list[8] =
    {
        ...
        {
            //la1	色検知、右カーブ(右から右)
            {Section::VIRTUAL, 0, 0, {0,0}, 10, 0, 0, -8.5, Section::TURNANGLE, -83, {0,0}, BLUE, 0, 39, 25, 5, false},
    ...
    pass_list[14] =
    {
        {1.0,0.0},{2.0,1.0},2.0,SOUTH,
        {
            ...
            {Section::TRACER, 0, 0, {0, 0}, 7, 0, 0, 0, Section::LENGTH, 10, {0, 0}, BLUE, 0, 20, 10, 3, false},
            {Section::TRACER, 0, 0, {0, 0}, 15, 0, 0, 0, Section::LENGTH, 7, {0, 0}, BLUE, 0, 25, 15, 5, false},
    ...
    pass_list[30] =
    {
        {1.0,1.0},{0.5,2.5},9.0,SOUTH,
        {
            ...
            //le2	右ななめ(左から右)
			{Section::WALKER, 20, 0, {0,0}, 0, 0, 0, 0, Section::LENGTH, 5, {0,0}, BLUE, 0, 39, 25, 5, true},
			{Section::VIRTUAL, 0, 0, {0,0}, 17, 0, 0, -16, Section::TURNANGLE, -50.5, {0,0}, BLUE, 0, 30, 25, 3, true},
			{Section::WALKER, 0, 0, {0,0}, 0, 0, 0, 0, Section::STOP, 50, {0,0}, BLUE, 0, 0, 0, 0, true},
			{Section::WALKER, -20, 0, {0,0}, 0, 0, 0, 0, Section::LENGTH, -5, {0,0}, BLUE, 0, 39, 25, 5, true},
            {Section::VIRTUAL, 0, 0, {0,0}, -18, 0, 0, -11.5, Section::TURNANGLE, 50.5, {0,0}, BLUE, 0, 39, 25, 5, false},
            {Section::VIRTUAL2, 0, 0, {0,0}, -23, 0, 0, 230.5, Section::LENGTH, -7, {0,0}, BLUE, 0, 39, 25, 7, true},
            {Section::WALKER, 0, 0, {0,0}, 0, 0, 0, 0, Section::STOP, 50, {0,0}, BLUE, 0, 0, 0, 0, true},
            //{Section::TRACER, 0, 0, {0,0}, 20, 0, 0, 0, Section::LENGTH, 15, {0,0}, BLUE, 0, 39, 25, 5, false},
            {Section::WALKER, 22, 0, {0, 0}, 0, 0, 0, 0, Section::COLOR, 0, {1,2}, BLUE, 0, 39, 25, 5, false},
            //終了
