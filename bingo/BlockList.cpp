...
void BlockList::initList()
{
    ...
    pass_list[13] =
    {
        {1.0,0.0},{2.0,0.0},3.0,EAST,
        {
            ...
            {Section::VIRTUAL, 0, 0, {0,0}, 14, 0, 0, -21.5, Section::TURNANGLE, -48.7, {0,0}, BLUE, 0, 39, 25, 5, true},
            {Section::VIRTUAL2, 0, 0, {0,0}, 0, 0, 0, 0, Section::STOP, 50, {0,0}, BLUE, 0, 0, 0, 0, true},
            {Section::WALKER, -15, 0, {0,0}, 0, 0, 0, 0, Section::LENGTH, -2, {0,0}, BLUE, 0, 39, 25, 5, true},
            {Section::VIRTUAL, 0, 0, {0,0}, -16, 0, 0, -18.5, Section::TURNANGLE, 48.7, {0,0}, BLUE, 0, 39, 25, 5, false},
            {Section::WALKER, -15, 0, {0,0}, 0, 0, 0, 0, Section::LENGTH, -18, {0,0}, BLUE, 0, 39, 25, 5, true},
            {Section::VIRTUAL2, 0, 0, {0,0}, 0, 0, 0, 0, Section::STOP, 50, {0,0}, BLUE, 0, 0, 0, 0, true},
    ...
    pass_list[24] =
    {
        ...
        {
            //lb1	色検知、左カーブ(右から右)
			{Section::VIRTUAL, 0, 0, {0, 0}, 12, 0, 0, 10, Section::TURNANGLE, 95, {0, 0}, BLUE, 0, 24, 25, 5, false},
...
{Section::VIRTUAL, -1, 0, {0, 0}, 0, 0, 0, 0, Section::LENGTH, 0, {0, 0}, BLUE, 0, 0, 0, 0, false}
    ...
    pass_list[198] =
    {
        {3.0,0.0},{0.5,2.5},20.5,SOUTH,
        {
            ...
            {Section::VIRTUAL, 0, 0, {0,0}, 14, 0, 0, -21.5, Section::TURNANGLE, -48.7, {0,0}, BLUE, 0, 39, 25, 5, true},
            {Section::VIRTUAL2, 0, 0, {0,0}, 0, 0, 0, 0, Section::STOP, 50, {0,0}, BLUE, 0, 0, 0, 0, true},
            {Section::WALKER, -15, 0, {0,0}, 0, 0, 0, 0, Secton::LENGTH, -2, {0,0}, BLUE, 0, 39, 25, 5, true},
            {Section::VIRTUAL, 0, 0, {0,0}, -16, 0, 0, -18.5, Section::TURNANGLE, 48.7, {0,0}, BLUE, 0, 39, 25, 5, false},
            {Section::WALKER, -15, 0, {0,0}, 0, 0, 0, 0, Section::LENGTH, -18, {0,0}, BLUE, 0, 39, 25, 5, true},
            {Section::VIRTUAL2, 0, 0, {0,0}, 0, 0, 0, 0, Section::STOP, 50, {0,0}, BLUE, 0, 0, 0, 0, true},
            {Section::TRACER, 0, 0, {0,0}, 20, 0, 0, 0, Section::LENGTH, 16, {0,0}, BLUE, 0, 39, 25, 5, false},
